  ...
  CREATE TABLE "SICAS_OC"."TELEFONOS_PNJ" 
   (	"TIPO_DOC_IDENTIFICACION" VARCHAR2(6) NOT NULL ENABLE, 
	"NUM_DOC_IDENTIFICACION" VARCHAR2(20) NOT NULL ENABLE, 
	"TIPO_TELEFONO" VARCHAR2(6) NOT NULL ENABLE, 
	"CORRELATIVO_TELEFONO" NUMBER(5,0) NOT NULL ENABLE, 
	"CODIGO_AREA" VARCHAR2(6) NOT NULL ENABLE, 
	"NUMERO_TELEFONO" VARCHAR2(20), 
	"EXTENSION" VARCHAR2(10), 
	"TELEFONO_PRINCIPAL" VARCHAR2(1) NOT NULL ENABLE, 
	 PRIMARY KEY ("TIPO_DOC_IDENTIFICACION", "NUM_DOC_IDENTIFICACION", "CORRELATIVO_TELEFONO")
