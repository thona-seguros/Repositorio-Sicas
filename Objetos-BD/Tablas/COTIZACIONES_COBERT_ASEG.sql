  ...
  CREATE TABLE "SICAS_OC"."COTIZACIONES_COBERT_ASEG" 
   (	"CODCIA" NUMBER(14,0) NOT NULL ENABLE, 
	...
	"PRIMAPROMEDIO" NUMBER(28,2), 
	 CONSTRAINT "PK_COTIZACIONES_COBERT_ASEG" PRIMARY KEY ("CODCIA", "CODEMPRESA", "IDCOTIZACION", "IDETCOTIZACION", "IDASEGURADO", "CODCOBERT")
