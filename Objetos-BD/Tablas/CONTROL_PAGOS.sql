...
CREATE TABLE SICAS_OC.CONTROL_PAGOS(
                                ID_CONTROL          VARCHAR2(25)    NOT NULL
                                ,CODCIA             NUMBER          NOT NULL
                                ,TIPO_PROCESO       NUMBER          NOT NULL
...
COMMENT ON COLUMN SICAS_OC.CONTROL_PAGOS.FECHA_PROCESO 		IS 'FECHA DEL DIA QUE SE REALIZA EL PROCESO DE LA INFORMACIÓN';
