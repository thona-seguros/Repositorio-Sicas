  ...
  CREATE TABLE "SICAS_OC"."BONOS_AGENTES_PROYECCION_FACT" 
   (	"CODCIA" NUMBER(14,0) NOT NULL ENABLE, 
	...
	"FECHAEMIFACT" DATE NOT NULL ENABLE, 
	"MONTOFACTMONEDA" NUMBER(14,2), 
	"APLICATITULAR" VARCHAR2(1), 
	"PORCENASEGTIT" NUMBER(12,6), 
	 CONSTRAINT "PK_BONOS_AGENTES_PROY_FACT" PRIMARY KEY ("CODCIA", "CODEMPRESA", "IDBONOVENTAS", "IDCALCULOPROY", "CODNIVEL", "CODAGENTE", "FECINICALCBONO", "FECFINCALCBONO", "IDPOLIZA", "IDFACTURA")
