  ...
  CREATE TABLE "SICAS_OC"."COTIZACIONES_COBERT_MASTER" 
   (	"CODCIA" NUMBER(14,0) NOT NULL ENABLE, 
	...
	"PRIMAPROMEDIO" NUMBER(28,2), 
	 CONSTRAINT "PK_COTIZACIONES_COBERT_MASTER" PRIMARY KEY ("CODCIA", "CODEMPRESA", "IDCOTIZACION", "IDETCOTIZACION", "CODCOBERT")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "IDX_SICASOC"  ENABLE, 
	 CONSTRAINT "FK_COB_MASTER_DETALLE" FOREIGN KEY ("CODCIA", "CODEMPRESA", "IDCOTIZACION", "IDETCOTIZACION")
