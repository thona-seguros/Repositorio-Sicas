...
--
CREATE OR REPLACE FORCE VIEW SICAS_OC.VW_INDICADOR_POLIZA
(POL_CODCIA, POL_CODEMPRESA, POL_IDCOTIZACION, POL_IDTIPOSEG, POL_CODRAMO, 
 POL_RAMO, POL_PLANCOB, POL_CODSUBRAMO, POL_SUBRAMO, POL_IDPOLIZA, 
 POL_NUMRENOV, POL_CODGRUPOEC, POL_CONTRA_REA, POL_CLIENTE, POL_NUMDET, 
 POL_NUMPOLUNICO, POL_STSPOLIZA, POL_FECSTATUS, POL_FECEMISION, POL_FECINIVIG, 
 POL_FECFINVIG, POL_FECRENOVACION, POL_FECANUL, POL_CODAGENTE, POL_AGENTE, 
 POL_CODPROMOTOR, POL_PROMOTOR, POL_CODDR, POL_DR, POL_CODPLANPAGO, 
 POL_CODCANALFORMAVENTA, POL_CANALFORMAVENTA, POL_CODAGRUPADOR, POL_AGRUPADOR, POL_CODTIPONEGOCIO, 
 POL_TIPONEGOCIO, POL_CODCATEGO, POL_CATEGORIA, POL_CODFUENTERECURSOS, POL_FUENTERECURSOS, 
 POL_CODOFICINA, POL_OFICINA, POL_GIRONEGOCIO, POL_ESCONTRIBUTORIO, POL_PORCENCONTRIBUTORIO, 
 POL_PLATAFOMA_WEB, POL_CODPAQCOMERCIAL, POL_COD_MONEDA, POL_SUMA_ASEG_LOCAL, POL_SUMA_ASEG_MONEDA, 
 POL_PRIMA_LOCAL, POL_PRIMA_MONEDA)
AS 
(
 SELECT 
...
--
-- VW_INDICADOR_POLIZA  (Synonym) 
--
--  Dependencies: 
--   VW_INDICADOR_POLIZA (View)
--
CREATE OR REPLACE PUBLIC SYNONYM VW_INDICADOR_POLIZA FOR SICAS_OC.VW_INDICADOR_POLIZA
/


GRANT SELECT ON SICAS_OC.VW_INDICADOR_POLIZA TO PUBLIC
/
