CREATE VIEW GET_BENEF_SIN (IDPOLIZA, IDSINIESTRO, BENEF,NOMBRE_BENEFICIARIO,BANCO,CUENTA_CLAVE,ENT_FINANCIERA,	NUMCUENTABANCARIA, CUENTA_BANCARIA,	TELEFONO,	NUM_IDENTIFICACION,	COD_CONVENIO,	EMAIL,	NUM_DOC_TRIBUTARIO,	TP_IDENTIFICACION
) AS



GET_BENEF_SIN AS(SELECT BES.IDPOLIZA
						,BES.IDSINIESTRO
						,BES.BENEF
