  ...
  CREATE OR REPLACE FORCE VIEW "SICAS_OC"."VW_CALENDARIO_ALERTAS" ("CODCIA", "CODESQUEMA", "DESCESQUEMA", "IDESQCONTRATO", "IDCAPACONTRATO", "CODEMPRESAGREMIO", "DESCEMPRESAGREMIO", "CODINTERREASEG", "IDCALENDARIO", "IDALERTA", "EVENTO", "FECHABASE", "TIPO", "DIAS", "FECHAALERTA", "REPETIR", "CORREOS") AS 
  SELECT CAL.CODCIA,
          CAL.CODESQUEMA,
          ESQ.DESCESQUEMA,
          CAL.IDESQCONTRATO,
