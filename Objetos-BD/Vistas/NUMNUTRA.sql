  ...
  CREATE OR REPLACE FORCE VIEW "SICAS_OC"."NUMNUTRA" ("POLIZA_UNICA", "POLIZA", "CODIGO_ASEGURADO", "NUMERO_TRABAJADOR", "NOMBRE", "APELLIDO_PATERNO", "APELLIDO_MATERNO", "TIPO_IDENTIFICACION", "NUM_IDENTIFICACION") AS 
