CREATE OR REPLACE VIEW POLIZAS_RESERVAS_SIN_FONACO(Ramo,Fec_Notificacion,Num_Siniestro,NumPoliza,IDPOLIZA,FecchaOcurrenciaSiniestro,EstadoOcurrenciaSiniestro,FolioSiniestroPortal,Nombre_Contratant,
...
CREATE OR REPLACE PUBLIC SYNONYM POLIZAS_RESERVAS_SIN_FONACO FOR SICAS_OC.POLIZAS_RESERVAS_SIN_FONACO

/
GRANT SELECT ON SICAS_OC.POLIZAS_RESERVAS_SIN_FONACO TO PUBLIC
