  ...
  CREATE OR REPLACE FORCE VIEW "SICAS_OC"."VW_REPORTE360" ("RECIBO", "POLIZA", "IDPOLIZA", "NOMBRE_CONTRATANTE", "PERIODICIDAD_PAGO", "ORIGEN_RECIBO", "SUBGRUPO", "ENDOSO", "VENCIMIENTO", "DIAS_DE_VENCIDO", "ANTIGUEDAD", "PRIMA_NETA", "PRIMA_TOTAL", "ID_AGENTE", "NOMBRE_AGENTE", "COMISION_PORC_AG", "COMISION_AG", "ID_PROMOTOR", "NOMBRE_PROMOTOR", "COMISION_PORC_PRO", "COMISION_PRO", "ID_DIRREG", "NOMBRE_DIRECCION", "COMISION_PORC_DR", "COMISION_DR", "STATUS", "RAMO", "SI_SINIESTRO", "MONTO_RESERVA_PENDIENTE", "MONTO_PAGADO", "FECHA_REPORTE", "FEC_PARAMFIN_REP") AS 
  (SELECT "RECIBO",
           "POLIZA",
           "IDPOLIZA",
           "NOMBRE_CONTRATANTE",
