 CREATE VIEW GET_MONTO_PAGO (CODCIA,	CODEMPRESA,	IDPOLIZA,	IDSINIESTRO,	IDTRANSACCION,	NUM_APROBACION,	BENEF,	IDDETSIN,	STSAPROBACION,	FECHA_TRANSACCION,	USUARIOGENERO USUARIO_GENERO, MONTO_PAGO

) AS
 
 GET_MONTO_PAGO AS (SELECT A.CODCIA
							,A.CODEMPRESA
							,A.IDPOLIZA
							,A.IDSINIESTRO
                            ,A.IDTRANSACCION
