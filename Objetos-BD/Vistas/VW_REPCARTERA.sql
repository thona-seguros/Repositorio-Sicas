  ...
  CREATE OR REPLACE FORCE VIEW "SICAS_OC"."VW_REPCARTERA" ("CODCIA", "CODEMPRESA", "CONSECUTIVO", "POLIZA", "AGRUPADOR", "RAMO", "CONTRATANTE", "INICIO_VIG", "FIN_VIG", "PLAN_PAGO", "NUM_SUBGRUPOS", "STATUS", "FECHA_STATUS", "PRIMA_NETA", "DERECHO_POLIZA", "RECARGO", "IVA", "PRIMA_TOTAL", "PRIMA_BASE", "MONTO_PAGADO", "CODIGO_AGENTE", "NOMBRE_AGENTE", "PORCENTAJE_AGENTE", "CANTIDAD_AGENTE", "CODIGO_PROMOTOR", "NOMBRE_PROMOTOR", "PORCENTAJE_PROMOTOR", "CANTIDAD_PROMOTOR", "CODIGO_DIRECCION", "NOMBRE_DIRECCION", "PORCENTAJE_DIRECCION", "CANTIDAD_DIRECCION") AS 
