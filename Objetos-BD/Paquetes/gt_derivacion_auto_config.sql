...
--   STANDARD (Package)
--   STANDARD (Package)
--   DERIVACION_AUTO_CONFIG (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_DERIVACION_AUTO_CONFIG AS
...
--
-- GT_DERIVACION_AUTO_CONFIG  (Package Body) 
--
--  Dependencies: 
--   GT_DERIVACION_AUTO_CONFIG (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_DERIVACION_AUTO_CONFIG AS
...
--
-- GT_DERIVACION_AUTO_CONFIG  (Synonym) 
--
--  Dependencies: 
--   GT_DERIVACION_AUTO_CONFIG (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_DERIVACION_AUTO_CONFIG FOR SICAS_OC.GT_DERIVACION_AUTO_CONFIG
/


GRANT EXECUTE ON SICAS_OC.GT_DERIVACION_AUTO_CONFIG TO PUBLIC
/
