...
--
-- OC_EMPLEADOS_FUNCIONARIOS  (Synonym) 
--
--  Dependencies: 
--   OC_EMPLEADOS_FUNCIONARIOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_EMPLEADOS_FUNCIONARIOS FOR SICAS_OC.OC_EMPLEADOS_FUNCIONARIOS
/


GRANT EXECUTE ON SICAS_OC.OC_EMPLEADOS_FUNCIONARIOS TO PUBLIC
/
