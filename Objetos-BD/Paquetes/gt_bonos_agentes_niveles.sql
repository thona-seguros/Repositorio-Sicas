...
--
-- GT_BONOS_AGENTES_NIVELES  (Synonym) 
--
--  Dependencies: 
--   GT_BONOS_AGENTES_NIVELES (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_BONOS_AGENTES_NIVELES FOR SICAS_OC.GT_BONOS_AGENTES_NIVELES
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_BONOS_AGENTES_NIVELES TO PUBLIC
/
