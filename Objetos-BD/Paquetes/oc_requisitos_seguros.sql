...
--
-- OC_REQUISITOS_SEGUROS  (Synonym) 
--
--  Dependencies: 
--   OC_REQUISITOS_SEGUROS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_REQUISITOS_SEGUROS FOR SICAS_OC.OC_REQUISITOS_SEGUROS
/


GRANT EXECUTE ON SICAS_OC.OC_REQUISITOS_SEGUROS TO PUBLIC
/
