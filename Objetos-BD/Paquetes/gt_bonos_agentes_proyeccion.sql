...
--   BONOS_AGENTES_PROYECCION (Table)
--   BONOS_AGENTES_RANGOS (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_BONOS_AGENTES_PROYECCION AS
...
--
-- GT_BONOS_AGENTES_PROYECCION  (Package Body) 
--
--  Dependencies: 
--   GT_BONOS_AGENTES_PROYECCION (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_BONOS_AGENTES_PROYECCION AS
...
--
-- GT_BONOS_AGENTES_PROYECCION  (Synonym) 
--
--  Dependencies: 
--   GT_BONOS_AGENTES_PROYECCION (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_BONOS_AGENTES_PROYECCION FOR SICAS_OC.GT_BONOS_AGENTES_PROYECCION
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_BONOS_AGENTES_PROYECCION TO PUBLIC
/
