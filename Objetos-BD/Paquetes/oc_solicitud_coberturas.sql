...
--
-- OC_SOLICITUD_COBERTURAS  (Synonym) 
--
--  Dependencies: 
--   OC_SOLICITUD_COBERTURAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_SOLICITUD_COBERTURAS FOR SICAS_OC.OC_SOLICITUD_COBERTURAS
/


GRANT EXECUTE ON SICAS_OC.OC_SOLICITUD_COBERTURAS TO PUBLIC
/
