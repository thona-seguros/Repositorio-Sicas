...
--
-- OC_RESERVAS_TECNICAS_ACCYENF  (Synonym) 
--
--  Dependencies: 
--   OC_RESERVAS_TECNICAS_ACCYENF (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_RESERVAS_TECNICAS_ACCYENF FOR SICAS_OC.OC_RESERVAS_TECNICAS_ACCYENF
/


GRANT EXECUTE ON SICAS_OC.OC_RESERVAS_TECNICAS_ACCYENF TO PUBLIC
/
