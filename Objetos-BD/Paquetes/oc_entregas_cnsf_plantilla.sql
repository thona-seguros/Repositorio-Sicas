...
--   ENTREGAS_CNSF_PLANTILLA (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_ENTREGAS_CNSF_PLANTILLA IS
...
--
-- OC_ENTREGAS_CNSF_PLANTILLA  (Package Body) 
--
--  Dependencies: 
--   OC_ENTREGAS_CNSF_PLANTILLA (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_ENTREGAS_CNSF_PLANTILLA IS
...
--
-- OC_ENTREGAS_CNSF_PLANTILLA  (Synonym) 
--
--  Dependencies: 
--   OC_ENTREGAS_CNSF_PLANTILLA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_ENTREGAS_CNSF_PLANTILLA FOR SICAS_OC.OC_ENTREGAS_CNSF_PLANTILLA
/


GRANT EXECUTE ON SICAS_OC.OC_ENTREGAS_CNSF_PLANTILLA TO PUBLIC
/
