...
--
-- OC_INFO_SINIESTRO  (Synonym) 
--
--  Dependencies: 
--   OC_INFO_SINIESTRO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_INFO_SINIESTRO FOR SICAS_OC.OC_INFO_SINIESTRO
/


GRANT EXECUTE ON SICAS_OC.OC_INFO_SINIESTRO TO PUBLIC
/
