CREATE OR REPLACE PACKAGE OC_PERSONAS_YOS IS
-- CREACION     05/10/2021
--
PROCEDURE INSERTA_REGISTROS(cTIPO_DOC_IDENTIFICACION          VARCHAR2,
...
--
PROCEDURE BORRA_MOVIMIENTO (cTIPO_DOC_IDENTIFICACION             VARCHAR2,
                            		         cNUM_DOC_IDENTIFICACION              VARCHAR2,
                            		         nNUM_CONSECUTIVO_YO                  NUMBER );
...
CREATE OR REPLACE PACKAGE BODY OC_PERSONAS_YOS IS
---
--- CREACION     05/10/2021
PROCEDURE INSERTA_REGISTROS(cTIPO_DOC_IDENTIFICACION             VARCHAR2,
                            		         cNUM_DOC_IDENTIFICACION             VARCHAR2,
...
BEGIN
       ...
       INSERT INTO PERSONAS_YOS (TIPO_DOC_IDENTIFICACION, NUM_DOC_IDENTIFICACION, NUM_CONSECUTIVO_YO,
       ...
       VALUES(cTIPO_DOC_IDENTIFICACION, cNUM_DOC_IDENTIFICACION, nNUM_CONSECUTIVO_YO, cNOMBRE_COMERCIAL, cDIRECCION_CALLE,
