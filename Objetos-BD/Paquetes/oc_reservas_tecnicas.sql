...
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_RESERVAS_TECNICAS AS
...
--
-- OC_RESERVAS_TECNICAS  (Package Body) 
--
--  Dependencies: 
--   OC_RESERVAS_TECNICAS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_RESERVAS_TECNICAS AS
...
--
-- OC_RESERVAS_TECNICAS  (Synonym) 
--
--  Dependencies: 
--   OC_RESERVAS_TECNICAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_RESERVAS_TECNICAS FOR SICAS_OC.OC_RESERVAS_TECNICAS
/


GRANT EXECUTE ON SICAS_OC.OC_RESERVAS_TECNICAS TO PUBLIC
/
