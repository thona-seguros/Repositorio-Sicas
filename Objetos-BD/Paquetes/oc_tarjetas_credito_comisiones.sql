--
-- OC_TARJETAS_CREDITO_COMISIONES  (Package) 
--
--  Dependencies: 
--   STANDARD (Package)
--   STANDARD (Package)
--   DBMS_STANDARD (Package)
--   TARJETAS_CREDITO_COMISIONES (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_TARJETAS_CREDITO_COMISIONES IS
...
--
-- OC_TARJETAS_CREDITO_COMISIONES  (Package Body) 
--
--  Dependencies: 
--   OC_TARJETAS_CREDITO_COMISIONES (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_TARJETAS_CREDITO_COMISIONES IS
...
--
-- OC_TARJETAS_CREDITO_COMISIONES  (Synonym) 
--
--  Dependencies: 
--   OC_TARJETAS_CREDITO_COMISIONES (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_TARJETAS_CREDITO_COMISIONES FOR SICAS_OC.OC_TARJETAS_CREDITO_COMISIONES
/


GRANT EXECUTE ON SICAS_OC.OC_TARJETAS_CREDITO_COMISIONES TO PUBLIC
/
