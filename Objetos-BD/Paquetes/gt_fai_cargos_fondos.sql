...
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_FAI_CARGOS_FONDOS AS
...
--
-- GT_FAI_CARGOS_FONDOS  (Package Body) 
--
--  Dependencies: 
--   GT_FAI_CARGOS_FONDOS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_FAI_CARGOS_FONDOS AS
...
--
-- GT_FAI_CARGOS_FONDOS  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_CARGOS_FONDOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_CARGOS_FONDOS FOR SICAS_OC.GT_FAI_CARGOS_FONDOS
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_CARGOS_FONDOS TO PUBLIC
/
