...
--
-- OC_RESERVAS_TECNICAS_GAAS  (Synonym) 
--
--  Dependencies: 
--   OC_RESERVAS_TECNICAS_GAAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_RESERVAS_TECNICAS_GAAS FOR SICAS_OC.OC_RESERVAS_TECNICAS_GAAS
/


GRANT EXECUTE ON SICAS_OC.OC_RESERVAS_TECNICAS_GAAS TO PUBLIC
/
