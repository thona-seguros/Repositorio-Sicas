...
--
  ...
  FUNCTION TIPO_DOC_IDENTIFICACION(nCodCliente NUMBER) RETURN VARCHAR2;
  
  FUNCTION NUM_DOC_IDENTIFICACION(nCodCliente NUMBER) RETURN VARCHAR2;
...
FUNCTION TIPO_DOC_IDENTIFICACION(nCodCliente NUMBER) RETURN VARCHAR2 IS
cTipo_Doc_Identificacion CLIENTES.Tipo_Doc_Identificacion%TYPE;
BEGIN
   BEGIN
   ...
   EXCEPTION
      WHEN NO_DATA_FOUND THEN
         RAISE_APPLICATION_ERROR(-20225,'No exsite el Cliente '||nCodCliente);
   END;
   RETURN cTipo_Doc_Identificacion;
END TIPO_DOC_IDENTIFICACION;
  
FUNCTION NUM_DOC_IDENTIFICACION(nCodCliente NUMBER) RETURN VARCHAR2 IS
cNum_Doc_Identificacion CLIENTES.Num_Doc_Identificacion%TYPE;
BEGIN
   BEGIN
      SELECT Num_Doc_Identificacion
        INTO cNum_Doc_Identificacion
        FROM CLIENTES A
       WHERE CodCliente = nCodCliente;
   EXCEPTION
      WHEN NO_DATA_FOUND THEN
