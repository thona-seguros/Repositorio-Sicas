...
--   REQUISITOS_PLAN_COBERT (Table)
--   REQUISITOS_SEGUROS (Table)
--   REQUISITO_COBERT_SEGURO (Table)
...
--
-- OC_EMPRESAS_DE_SEGUROS  (Package Body) 
--
--  Dependencies: 
--   OC_EMPRESAS_DE_SEGUROS (Package)
--
...
--
-- OC_EMPRESAS_DE_SEGUROS  (Synonym) 
--
--  Dependencies: 
--   OC_EMPRESAS_DE_SEGUROS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_EMPRESAS_DE_SEGUROS FOR SICAS_OC.OC_EMPRESAS_DE_SEGUROS
/


GRANT EXECUTE ON SICAS_OC.OC_EMPRESAS_DE_SEGUROS TO PUBLIC
/
