--
-- OC_ENTREGAS_CNSF_DATOS  (Package) 
--
--  Dependencies: 
--   STANDARD (Package)
--   STANDARD (Package)
--   ENTREGAS_CNSF_DATOS (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_ENTREGAS_CNSF_DATOS IS
...
--
-- OC_ENTREGAS_CNSF_DATOS  (Package Body) 
--
--  Dependencies: 
--   OC_ENTREGAS_CNSF_DATOS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_ENTREGAS_CNSF_DATOS IS
...
--
-- OC_ENTREGAS_CNSF_DATOS  (Synonym) 
--
--  Dependencies: 
--   OC_ENTREGAS_CNSF_DATOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_ENTREGAS_CNSF_DATOS FOR SICAS_OC.OC_ENTREGAS_CNSF_DATOS
/


GRANT EXECUTE ON SICAS_OC.OC_ENTREGAS_CNSF_DATOS TO PUBLIC
/
