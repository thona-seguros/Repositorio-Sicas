...
--
-- OC_FACT_ELECT_CLAVE_UNIDAD  (Synonym) 
--
--  Dependencies: 
--   OC_FACT_ELECT_CLAVE_UNIDAD (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_FACT_ELECT_CLAVE_UNIDAD FOR SICAS_OC.OC_FACT_ELECT_CLAVE_UNIDAD
/


GRANT EXECUTE ON SICAS_OC.OC_FACT_ELECT_CLAVE_UNIDAD TO PUBLIC
/
