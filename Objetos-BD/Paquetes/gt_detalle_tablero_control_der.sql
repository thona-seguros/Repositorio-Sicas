...
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_DETALLE_TABLERO_CONTROL_DER IS
...
--
-- GT_DETALLE_TABLERO_CONTROL_DER  (Package Body) 
--
--  Dependencies: 
--   GT_DETALLE_TABLERO_CONTROL_DER (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_DETALLE_TABLERO_CONTROL_DER IS
...
--
-- GT_DETALLE_TABLERO_CONTROL_DER  (Synonym) 
--
--  Dependencies: 
--   GT_DETALLE_TABLERO_CONTROL_DER (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_DETALLE_TABLERO_CONTROL_DER FOR SICAS_OC.GT_DETALLE_TABLERO_CONTROL_DER
/


GRANT EXECUTE ON SICAS_OC.GT_DETALLE_TABLERO_CONTROL_DER TO PUBLIC
/
