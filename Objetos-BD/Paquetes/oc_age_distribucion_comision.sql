...
--
-- OC_AGE_DISTRIBUCION_COMISION  (Synonym) 
--
--  Dependencies: 
--   OC_AGE_DISTRIBUCION_COMISION (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_AGE_DISTRIBUCION_COMISION FOR SICAS_OC.OC_AGE_DISTRIBUCION_COMISION
/


GRANT EXECUTE ON SICAS_OC.OC_AGE_DISTRIBUCION_COMISION TO PUBLIC
/
