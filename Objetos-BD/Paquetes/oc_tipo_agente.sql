...
--   TIPO_AGENTE (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_TIPO_AGENTE IS
...
--
-- OC_TIPO_AGENTE  (Package Body) 
--
--  Dependencies: 
--   OC_TIPO_AGENTE (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_TIPO_AGENTE IS
...
--
-- OC_TIPO_AGENTE  (Synonym) 
--
--  Dependencies: 
--   OC_TIPO_AGENTE (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_TIPO_AGENTE FOR SICAS_OC.OC_TIPO_AGENTE
/


GRANT EXECUTE ON SICAS_OC.OC_TIPO_AGENTE TO PUBLIC
/
