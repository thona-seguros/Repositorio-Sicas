...
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_BONOS_AGENTES_RANGOS AS
...
--
-- GT_BONOS_AGENTES_RANGOS  (Package Body) 
--
--  Dependencies: 
--   GT_BONOS_AGENTES_RANGOS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_BONOS_AGENTES_RANGOS AS
...
--
-- GT_BONOS_AGENTES_RANGOS  (Synonym) 
--
--  Dependencies: 
--   GT_BONOS_AGENTES_RANGOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_BONOS_AGENTES_RANGOS FOR SICAS_OC.GT_BONOS_AGENTES_RANGOS
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_BONOS_AGENTES_RANGOS TO PUBLIC
/
