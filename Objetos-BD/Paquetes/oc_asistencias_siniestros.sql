--
-- OC_ASISTENCIAS_SINIESTROS  (Package) 
--
--  Dependencies: 
--   STANDARD (Package)
--   STANDARD (Package)
...
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_ASISTENCIAS_SINIESTROS IS
...
--
-- OC_ASISTENCIAS_SINIESTROS  (Package Body) 
--
--  Dependencies: 
--   OC_ASISTENCIAS_SINIESTROS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_ASISTENCIAS_SINIESTROS IS
--
--
--
...
--
-- OC_ASISTENCIAS_SINIESTROS  (Synonym) 
--
--  Dependencies: 
--   OC_ASISTENCIAS_SINIESTROS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_ASISTENCIAS_SINIESTROS FOR SICAS_OC.OC_ASISTENCIAS_SINIESTROS
/


GRANT EXECUTE ON SICAS_OC.OC_ASISTENCIAS_SINIESTROS TO PUBLIC
/
