CREATE OR REPLACE PACKAGE          OC_FACTOR_PADEC_ESPECIAL IS
   PROCEDURE INSERTAR( nCodCia      FACTOR_PADEC_ESPECIAL.CodCia%TYPE
                     ...
                     , cPlanCob     FACTOR_PADEC_ESPECIAL.PlanCob%TYPE
                     , cCodCobert   FACTOR_PADEC_ESPECIAL.CodCobert%TYPE
                     , cCodEndoso   FACTOR_PADEC_ESPECIAL.CodEndoso%TYPE
                     , cIndIncluido FACTOR_PADEC_ESPECIAL.IndIncluido%TYPE
                     , nFactor      FACTOR_PADEC_ESPECIAL.Factor%TYPE );

   PROCEDURE ELIMINAR( nCodCia     FACTOR_PADEC_ESPECIAL.CodCia%TYPE
                     , nCodEmpresa FACTOR_PADEC_ESPECIAL.CodEmpresa%TYPE
                     , cIdTipoSeg  FACTOR_PADEC_ESPECIAL.IdTipoSeg%TYPE
                     , cPlanCob    FACTOR_PADEC_ESPECIAL.PlanCob%TYPE
                     , cCodCobert  FACTOR_PADEC_ESPECIAL.CodCobert%TYPE
   ...
   FUNCTION SERVICIO_XML( nCodCia     FACTOR_PADEC_ESPECIAL.CodCia%TYPE
                        , nCodEmpresa FACTOR_PADEC_ESPECIAL.CodEmpresa%TYPE
                        , cIdTipoSeg  FACTOR_PADEC_ESPECIAL.IdTipoSeg%TYPE
                        , cPlanCob    FACTOR_PADEC_ESPECIAL.PlanCob%TYPE
                        , cCodCobert  FACTOR_PADEC_ESPECIAL.CodCobert%TYPE
                        , cCodEndoso  FACTOR_PADEC_ESPECIAL.CodEndoso%TYPE ) RETURN XMLTYPE;
...
CREATE OR REPLACE PACKAGE BODY          OC_FACTOR_PADEC_ESPECIAL IS
   PROCEDURE INSERTAR( nCodCia      FACTOR_PADEC_ESPECIAL.CodCia%TYPE
                     ...
                     , cCodEndoso   FACTOR_PADEC_ESPECIAL.CodEndoso%TYPE
                     , cIndIncluido FACTOR_PADEC_ESPECIAL.IndIncluido%TYPE
                     , nFactor      FACTOR_PADEC_ESPECIAL.Factor%TYPE ) IS
   BEGIN
       INSERT INTO FACTOR_PADEC_ESPECIAL
   ...
   PROCEDURE ELIMINAR( nCodCia     FACTOR_PADEC_ESPECIAL.CodCia%TYPE
                     ...
                     , cPlanCob    FACTOR_PADEC_ESPECIAL.PlanCob%TYPE
                     , cCodCobert  FACTOR_PADEC_ESPECIAL.CodCobert%TYPE
                     , cCodEndoso  FACTOR_PADEC_ESPECIAL.CodEndoso%TYPE ) IS
   BEGIN
       DELETE FACTOR_PADEC_ESPECIAL
   ...
   FUNCTION SERVICIO_XML( nCodCia     FACTOR_PADEC_ESPECIAL.CodCia%TYPE
                        ...
                        , cPlanCob    FACTOR_PADEC_ESPECIAL.PlanCob%TYPE
                        , cCodCobert  FACTOR_PADEC_ESPECIAL.CodCobert%TYPE
                        , cCodEndoso  FACTOR_PADEC_ESPECIAL.CodEndoso%TYPE ) RETURN XMLTYPE IS
      xResultado  XMLTYPE;
   BEGIN
      SELECT XMLROOT(
             XMLELEMENT("DATA",
                        ...
                        XMLAGG( XMLELEMENT("PADECIMIENTOESPECIAL", XMLFOREST( A.IndIncluido  "IndIncluido",
                                                                              A.Factor       "Factor",
   ...
   BEGIN
      FOR x IN cRegistros LOOP 
         ...
         IF cExisteFactor = 'N' THEN
            ...
            VALUES (nCodCia, nCodEmpresa, nIdCotizacion, x.IDetCotizacion, 'PADESP'  , x.CodEndoso, x.Factor );
         ELSE
            --
