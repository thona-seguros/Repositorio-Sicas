...
--
-- OC_CFG_ENDOSOS_SV  (Synonym) 
--
--  Dependencies: 
--   OC_CFG_ENDOSOS_SV (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CFG_ENDOSOS_SV FOR SICAS_OC.OC_CFG_ENDOSOS_SV
/


GRANT EXECUTE ON SICAS_OC.OC_CFG_ENDOSOS_SV TO PUBLIC
/
