--
-- OC_NOTAS_DE_CREDITO_POLIZA  (Package) 
--
--  Dependencies: 
--   STANDARD (Package)
--   STANDARD (Package)
...
--   NOTAS_DE_CREDITO_POLIZA (Table)
--   DETALLE_NOTAS_DE_CREDITO (Table)
--   TIPO_DE_DOCUMENTO (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_NOTAS_DE_CREDITO_POLIZA IS
...
--
-- OC_NOTAS_DE_CREDITO_POLIZA  (Package Body) 
--
--  Dependencies: 
--   OC_NOTAS_DE_CREDITO_POLIZA (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_NOTAS_DE_CREDITO_POLIZA IS
...
--
-- OC_NOTAS_DE_CREDITO_POLIZA  (Synonym) 
--
--  Dependencies: 
--   OC_NOTAS_DE_CREDITO_POLIZA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_NOTAS_DE_CREDITO_POLIZA FOR SICAS_OC.OC_NOTAS_DE_CREDITO_POLIZA
/


GRANT EXECUTE ON SICAS_OC.OC_NOTAS_DE_CREDITO_POLIZA TO PUBLIC
/
