...
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_FAI_BONOS_FONDOS_RANGOS AS
...
--
-- GT_FAI_BONOS_FONDOS_RANGOS  (Package Body) 
--
--  Dependencies: 
--   GT_FAI_BONOS_FONDOS_RANGOS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_FAI_BONOS_FONDOS_RANGOS AS
...
--
-- GT_FAI_BONOS_FONDOS_RANGOS  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_BONOS_FONDOS_RANGOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_BONOS_FONDOS_RANGOS FOR SICAS_OC.GT_FAI_BONOS_FONDOS_RANGOS
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_BONOS_FONDOS_RANGOS TO PUBLIC
/
