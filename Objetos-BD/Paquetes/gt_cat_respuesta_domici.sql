...
--
-- GT_CAT_RESPUESTA_DOMICI  (Synonym) 
--
--  Dependencies: 
--   GT_CAT_RESPUESTA_DOMICI (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_CAT_RESPUESTA_DOMICI FOR SICAS_OC.GT_CAT_RESPUESTA_DOMICI
/


GRANT EXECUTE ON SICAS_OC.GT_CAT_RESPUESTA_DOMICI TO PUBLIC
/
