...
--   GT_FAI_PLAN_RETIRO_FALLEC (Package)
--   FAI_BONOS_FONDOS (Table)
--   FAI_BONOS_FONDOS (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_FAI_TIPOS_DE_FONDOS AS
...
--
-- GT_FAI_TIPOS_DE_FONDOS  (Package Body) 
--
--  Dependencies: 
--   GT_FAI_TIPOS_DE_FONDOS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_FAI_TIPOS_DE_FONDOS AS
...
--
-- GT_FAI_TIPOS_DE_FONDOS  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_TIPOS_DE_FONDOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_TIPOS_DE_FONDOS FOR SICAS_OC.GT_FAI_TIPOS_DE_FONDOS
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_TIPOS_DE_FONDOS TO PUBLIC
/
