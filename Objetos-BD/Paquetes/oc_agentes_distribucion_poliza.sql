...
--
-- OC_AGENTES_DISTRIBUCION_POLIZA  (Synonym) 
--
--  Dependencies: 
--   OC_AGENTES_DISTRIBUCION_POLIZA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_AGENTES_DISTRIBUCION_POLIZA FOR SICAS_OC.OC_AGENTES_DISTRIBUCION_POLIZA
/


GRANT EXECUTE ON SICAS_OC.OC_AGENTES_DISTRIBUCION_POLIZA TO PUBLIC
/
