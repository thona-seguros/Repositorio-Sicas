...
--   STANDARD (Package)
--   STANDARD (Package)
--   TABLAS_MORTALIDAD (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_TABLAS_MORTALIDAD AS
...
--
-- OC_TABLAS_MORTALIDAD  (Package Body) 
--
--  Dependencies: 
--   OC_TABLAS_MORTALIDAD (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_TABLAS_MORTALIDAD AS
...
--
-- OC_TABLAS_MORTALIDAD  (Synonym) 
--
--  Dependencies: 
--   OC_TABLAS_MORTALIDAD (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_TABLAS_MORTALIDAD FOR SICAS_OC.OC_TABLAS_MORTALIDAD
/


GRANT EXECUTE ON SICAS_OC.OC_TABLAS_MORTALIDAD TO PUBLIC
/
