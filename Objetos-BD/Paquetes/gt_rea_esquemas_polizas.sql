...
--
-- GT_REA_ESQUEMAS_POLIZAS  (Synonym) 
--
--  Dependencies: 
--   GT_REA_ESQUEMAS_POLIZAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_REA_ESQUEMAS_POLIZAS FOR SICAS_OC.GT_REA_ESQUEMAS_POLIZAS
/


GRANT EXECUTE ON SICAS_OC.GT_REA_ESQUEMAS_POLIZAS TO PUBLIC
/
