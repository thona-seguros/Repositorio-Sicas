...
--
-- GT_BONOS_AGENTES_NEGOCIOS  (Synonym) 
--
--  Dependencies: 
--   GT_BONOS_AGENTES_NEGOCIOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_BONOS_AGENTES_NEGOCIOS FOR SICAS_OC.GT_BONOS_AGENTES_NEGOCIOS
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_BONOS_AGENTES_NEGOCIOS TO PUBLIC
/
