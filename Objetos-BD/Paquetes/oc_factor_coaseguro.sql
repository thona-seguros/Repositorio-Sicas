...
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_FACTOR_COASEGURO IS
...
--
-- OC_FACTOR_COASEGURO  (Package Body) 
--
--  Dependencies: 
--   OC_FACTOR_COASEGURO (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_FACTOR_COASEGURO IS
...
--
-- OC_FACTOR_COASEGURO  (Synonym) 
--
--  Dependencies: 
--   OC_FACTOR_COASEGURO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_FACTOR_COASEGURO FOR SICAS_OC.OC_FACTOR_COASEGURO
/


GRANT EXECUTE ON SICAS_OC.OC_FACTOR_COASEGURO TO PUBLIC
/
