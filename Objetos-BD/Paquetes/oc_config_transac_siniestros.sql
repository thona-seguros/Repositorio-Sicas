...
--
-- OC_CONFIG_TRANSAC_SINIESTROS  (Package Body) 
--
--  Dependencies: 
--   OC_CONFIG_TRANSAC_SINIESTROS (Package)
--
...
--
-- OC_CONFIG_TRANSAC_SINIESTROS  (Synonym) 
--
--  Dependencies: 
--   OC_CONFIG_TRANSAC_SINIESTROS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONFIG_TRANSAC_SINIESTROS FOR SICAS_OC.OC_CONFIG_TRANSAC_SINIESTROS
/


GRANT EXECUTE ON SICAS_OC.OC_CONFIG_TRANSAC_SINIESTROS TO PUBLIC
/
