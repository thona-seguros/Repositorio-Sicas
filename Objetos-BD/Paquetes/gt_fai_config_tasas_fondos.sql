...
--
-- GT_FAI_CONFIG_TASAS_FONDOS  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_CONFIG_TASAS_FONDOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_CONFIG_TASAS_FONDOS FOR SICAS_OC.GT_FAI_CONFIG_TASAS_FONDOS
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_CONFIG_TASAS_FONDOS TO PUBLIC
/
