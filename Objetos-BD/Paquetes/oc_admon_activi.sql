...
--   ENDOSOS (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_ADMON_ACTIVI IS
...
--
-- OC_ADMON_ACTIVI  (Package Body) 
--
--  Dependencies: 
--   OC_ADMON_ACTIVI (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_ADMON_ACTIVI IS
--
-- BITACORA DE CAMBIO
-- ALTA   JICO 20170814
PROCEDURE VALIDA_ASEGURADO(P_CODCIA     NUMBER,
...
--
-- OC_ADMON_ACTIVI  (Synonym) 
--
--  Dependencies: 
--   OC_ADMON_ACTIVI (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_ADMON_ACTIVI FOR SICAS_OC.OC_ADMON_ACTIVI
/


GRANT EXECUTE ON SICAS_OC.OC_ADMON_ACTIVI TO PUBLIC
/
