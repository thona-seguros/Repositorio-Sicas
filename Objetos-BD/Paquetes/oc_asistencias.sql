...
--   ASISTENCIAS (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_ASISTENCIAS IS
...
--
-- OC_ASISTENCIAS  (Package Body) 
--
--  Dependencies: 
--   OC_ASISTENCIAS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_ASISTENCIAS IS
...
--
-- OC_ASISTENCIAS  (Synonym) 
--
--  Dependencies: 
--   OC_ASISTENCIAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_ASISTENCIAS FOR SICAS_OC.OC_ASISTENCIAS
/


GRANT EXECUTE ON SICAS_OC.OC_ASISTENCIAS TO PUBLIC
/
