...
--   FACTURAS (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_CONCEPTOS_PLAN_DE_PAGOS IS
...
--
-- OC_CONCEPTOS_PLAN_DE_PAGOS  (Package Body) 
--
--  Dependencies: 
--   OC_CONCEPTOS_PLAN_DE_PAGOS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_CONCEPTOS_PLAN_DE_PAGOS IS
...
--
-- OC_CONCEPTOS_PLAN_DE_PAGOS  (Synonym) 
--
--  Dependencies: 
--   OC_CONCEPTOS_PLAN_DE_PAGOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONCEPTOS_PLAN_DE_PAGOS FOR SICAS_OC.OC_CONCEPTOS_PLAN_DE_PAGOS
/


GRANT EXECUTE ON SICAS_OC.OC_CONCEPTOS_PLAN_DE_PAGOS TO PUBLIC
/
