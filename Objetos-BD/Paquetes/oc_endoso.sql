	...
	*/  -- FIN ENDOINA
	...
	BEGIN
	  ...
	  --    
          ...
          --
          cTexto := replace(cTexto, '&FECHAINICIO', OC_GENERALES.FECHA_EN_LETRAS(dFecAnulacion));
          cTexto := replace(cTexto, '&FECHAFIN', OC_GENERALES.FECHA_EN_LETRAS(dFecFinVig));
          CLINEA_T := replace(CLINEA_T, '&FECHAINICIO', OC_GENERALES.FECHA_EN_LETRAS(dFecAnulacion));
          CLINEA_T := replace(CLINEA_T, '&FECHAFIN', OC_GENERALES.FECHA_EN_LETRAS(dFecFinVig));
          --
