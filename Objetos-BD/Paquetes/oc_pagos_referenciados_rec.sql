--
-- OC_PAGOS_REFERENCIADOS_REC  (Package) 
--
--  Dependencies: 
--   STANDARD (Package)
--   STANDARD (Package)
...
--   TRANSACCION (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_PAGOS_REFERENCIADOS_REC IS
...
--
-- OC_PAGOS_REFERENCIADOS_REC  (Package Body) 
--
--  Dependencies: 
--   OC_PAGOS_REFERENCIADOS_REC (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_PAGOS_REFERENCIADOS_REC IS
...
--
-- OC_PAGOS_REFERENCIADOS_REC  (Synonym) 
--
--  Dependencies: 
--   OC_PAGOS_REFERENCIADOS_REC (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_PAGOS_REFERENCIADOS_REC FOR SICAS_OC.OC_PAGOS_REFERENCIADOS_REC
/


GRANT EXECUTE ON SICAS_OC.OC_PAGOS_REFERENCIADOS_REC TO PUBLIC
/
