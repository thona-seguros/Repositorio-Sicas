...
--
-- GT_FAI_DESCANSO_APORTACIONES  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_DESCANSO_APORTACIONES (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_DESCANSO_APORTACIONES FOR SICAS_OC.GT_FAI_DESCANSO_APORTACIONES
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_DESCANSO_APORTACIONES TO PUBLIC
/
