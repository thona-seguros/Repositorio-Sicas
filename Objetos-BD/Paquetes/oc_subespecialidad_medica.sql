...
--
-- OC_SUBESPECIALIDAD_MEDICA  (Synonym) 
--
--  Dependencies: 
--   OC_SUBESPECIALIDAD_MEDICA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_SUBESPECIALIDAD_MEDICA FOR SICAS_OC.OC_SUBESPECIALIDAD_MEDICA
/


GRANT EXECUTE ON SICAS_OC.OC_SUBESPECIALIDAD_MEDICA TO PUBLIC
/
