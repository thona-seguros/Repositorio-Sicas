...
--
-- OC_PLANTILLAS_CONTABLES  (Synonym) 
--
--  Dependencies: 
--   OC_PLANTILLAS_CONTABLES (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_PLANTILLAS_CONTABLES FOR SICAS_OC.OC_PLANTILLAS_CONTABLES
/


GRANT EXECUTE ON SICAS_OC.OC_PLANTILLAS_CONTABLES TO PUBLIC
/
