...
--
-- GT_EAD_CONTROL_ASEGURADOS  (Synonym) 
--
--  Dependencies: 
--   GT_EAD_CONTROL_ASEGURADOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_EAD_CONTROL_ASEGURADOS FOR SICAS_OC.GT_EAD_CONTROL_ASEGURADOS
/


GRANT EXECUTE ON SICAS_OC.GT_EAD_CONTROL_ASEGURADOS TO PUBLIC
/
