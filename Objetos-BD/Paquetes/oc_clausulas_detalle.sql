...
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_CLAUSULAS_DETALLE IS
...
--
-- OC_CLAUSULAS_DETALLE  (Package Body) 
--
--  Dependencies: 
--   OC_CLAUSULAS_DETALLE (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_CLAUSULAS_DETALLE IS
--
-- BITACORA DE CAMBIO
...
--
-- OC_CLAUSULAS_DETALLE  (Synonym) 
--
--  Dependencies: 
--   OC_CLAUSULAS_DETALLE (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CLAUSULAS_DETALLE FOR SICAS_OC.OC_CLAUSULAS_DETALLE
/


GRANT EXECUTE ON SICAS_OC.OC_CLAUSULAS_DETALLE TO PUBLIC
/
