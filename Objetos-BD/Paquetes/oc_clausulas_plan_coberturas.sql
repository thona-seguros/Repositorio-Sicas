...
--
-- OC_CLAUSULAS_PLAN_COBERTURAS  (Synonym) 
--
--  Dependencies: 
--   OC_CLAUSULAS_PLAN_COBERTURAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CLAUSULAS_PLAN_COBERTURAS FOR SICAS_OC.OC_CLAUSULAS_PLAN_COBERTURAS
/


GRANT EXECUTE ON SICAS_OC.OC_CLAUSULAS_PLAN_COBERTURAS TO PUBLIC
/
