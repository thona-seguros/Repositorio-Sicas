...
--
-- GT_FAI_CONF_TIPO_INCENTIVO  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_CONF_TIPO_INCENTIVO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_CONF_TIPO_INCENTIVO FOR SICAS_OC.GT_FAI_CONF_TIPO_INCENTIVO
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_CONF_TIPO_INCENTIVO TO PUBLIC
/
