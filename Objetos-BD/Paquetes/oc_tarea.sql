...
--   TAREA (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_TAREA IS
...
--
-- OC_TAREA  (Package Body) 
--
--  Dependencies: 
--   OC_TAREA (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_TAREA IS
...
--   OC_TAREA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_TAREA FOR SICAS_OC.OC_TAREA
/


GRANT EXECUTE ON SICAS_OC.OC_TAREA TO PUBLIC
/
