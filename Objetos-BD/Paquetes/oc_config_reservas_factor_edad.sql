...
--
-- OC_CONFIG_RESERVAS_FACTOR_EDAD  (Synonym) 
--
--  Dependencies: 
--   OC_CONFIG_RESERVAS_FACTOR_EDAD (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONFIG_RESERVAS_FACTOR_EDAD FOR SICAS_OC.OC_CONFIG_RESERVAS_FACTOR_EDAD
/


GRANT EXECUTE ON SICAS_OC.OC_CONFIG_RESERVAS_FACTOR_EDAD TO PUBLIC
/
