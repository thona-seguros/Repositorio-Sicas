--
-- OC_TIPO_PROVEEDOR  (Package) 
--
--  Dependencies: 
--   STANDARD (Package)
--   STANDARD (Package)
--   DBMS_STANDARD (Package)
--   TIPO_PROVEEDOR (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_TIPO_PROVEEDOR IS
...
--
-- OC_TIPO_PROVEEDOR  (Package Body) 
--
--  Dependencies: 
--   OC_TIPO_PROVEEDOR (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_TIPO_PROVEEDOR IS
...
--
-- OC_TIPO_PROVEEDOR  (Synonym) 
--
--  Dependencies: 
--   OC_TIPO_PROVEEDOR (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_TIPO_PROVEEDOR FOR SICAS_OC.OC_TIPO_PROVEEDOR
/


GRANT EXECUTE ON SICAS_OC.OC_TIPO_PROVEEDOR TO PUBLIC
/
