...
--   PROC_TAREA (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_SUB_PROCESO IS
...
--
-- OC_SUB_PROCESO  (Package Body) 
--
--  Dependencies: 
--   OC_SUB_PROCESO (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_SUB_PROCESO IS
...
--
-- OC_SUB_PROCESO  (Synonym) 
--
--  Dependencies: 
--   OC_SUB_PROCESO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_SUB_PROCESO FOR SICAS_OC.OC_SUB_PROCESO
/


GRANT EXECUTE ON SICAS_OC.OC_SUB_PROCESO TO PUBLIC
/
