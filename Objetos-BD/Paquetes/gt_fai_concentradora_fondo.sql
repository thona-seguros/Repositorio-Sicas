...
--   GT_FAI_CARGOS_BONOS_FONDO_POL (Package)
--   GT_FAI_CARGOS_FONDOS (Package)
...
--   FAI_BONOS_FONDOS_RANGOS (Table)
--   TRANSACCION (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_FAI_CONCENTRADORA_FONDO AS
...
--
-- GT_FAI_CONCENTRADORA_FONDO  (Package Body) 
--
--  Dependencies: 
--   GT_FAI_CONCENTRADORA_FONDO (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_FAI_CONCENTRADORA_FONDO AS
...
--
-- GT_FAI_CONCENTRADORA_FONDO  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_CONCENTRADORA_FONDO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_CONCENTRADORA_FONDO FOR SICAS_OC.GT_FAI_CONCENTRADORA_FONDO
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_CONCENTRADORA_FONDO TO PUBLIC
/
