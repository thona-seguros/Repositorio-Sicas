...
--
-- OC_POLIZAS_RESUMEN_ENDOSO_CLA  (Synonym) 
--
--  Dependencies: 
--   OC_POLIZAS_RESUMEN_ENDOSO_CLA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_POLIZAS_RESUMEN_ENDOSO_CLA FOR SICAS_OC.OC_POLIZAS_RESUMEN_ENDOSO_CLA
/


GRANT EXECUTE ON SICAS_OC.OC_POLIZAS_RESUMEN_ENDOSO_CLA TO PUBLIC
/
