...
--
-- OC_SALARIO_MINIMO  (Synonym) 
--
--  Dependencies: 
--   OC_SALARIO_MINIMO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_SALARIO_MINIMO FOR SICAS_OC.OC_SALARIO_MINIMO
/


GRANT EXECUTE ON SICAS_OC.OC_SALARIO_MINIMO TO PUBLIC
/
