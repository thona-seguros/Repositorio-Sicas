...
--
-- GT_COTIZACIONES_CLAUSULAS  (Synonym) 
--
--  Dependencies: 
--   GT_COTIZACIONES_CLAUSULAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_COTIZACIONES_CLAUSULAS FOR SICAS_OC.GT_COTIZACIONES_CLAUSULAS
/


GRANT EXECUTE ON SICAS_OC.GT_COTIZACIONES_CLAUSULAS TO PUBLIC
/
