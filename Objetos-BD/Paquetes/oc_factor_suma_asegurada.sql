...
--
-- OC_FACTOR_SUMA_ASEGURADA  (Synonym) 
--
--  Dependencies: 
--   OC_FACTOR_SUMA_ASEGURADA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_FACTOR_SUMA_ASEGURADA FOR SICAS_OC.OC_FACTOR_SUMA_ASEGURADA
/


GRANT EXECUTE ON SICAS_OC.OC_FACTOR_SUMA_ASEGURADA TO PUBLIC
/
