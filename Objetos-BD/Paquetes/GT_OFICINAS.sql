...
--   OFICINAS (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_OFICINAS IS
...
--
-- GT_OFICINAS  (Package Body) 
--
--  Dependencies: 
--   GT_OFICINAS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_OFICINAS IS
...
--   GT_OFICINAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_OFICINAS FOR SICAS_OC.GT_OFICINAS
/


GRANT EXECUTE ON SICAS_OC.GT_OFICINAS TO PUBLIC
/
