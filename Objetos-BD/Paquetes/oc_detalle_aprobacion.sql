...
--
-- OC_DETALLE_APROBACION  (Synonym) 
--
--  Dependencies: 
--   OC_DETALLE_APROBACION (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_DETALLE_APROBACION FOR SICAS_OC.OC_DETALLE_APROBACION
/


GRANT EXECUTE ON SICAS_OC.OC_DETALLE_APROBACION TO PUBLIC
/
