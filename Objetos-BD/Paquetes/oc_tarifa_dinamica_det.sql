...
--
-- OC_TARIFA_DINAMICA_DET  (Synonym) 
--
--  Dependencies: 
--   OC_TARIFA_DINAMICA_DET (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_TARIFA_DINAMICA_DET FOR SICAS_OC.OC_TARIFA_DINAMICA_DET
/


GRANT EXECUTE ON SICAS_OC.OC_TARIFA_DINAMICA_DET TO PUBLIC
/
