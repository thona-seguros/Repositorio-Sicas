...
--
-- OC_FACTOR_ZONA_GEOGRAFICA  (Synonym) 
--
--  Dependencies: 
--   OC_FACTOR_ZONA_GEOGRAFICA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_FACTOR_ZONA_GEOGRAFICA FOR SICAS_OC.OC_FACTOR_ZONA_GEOGRAFICA
/


GRANT EXECUTE ON SICAS_OC.OC_FACTOR_ZONA_GEOGRAFICA TO PUBLIC
/
