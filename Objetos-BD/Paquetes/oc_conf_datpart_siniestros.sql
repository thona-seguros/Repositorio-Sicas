...
--
-- OC_CONF_DATPART_SINIESTROS  (Synonym) 
--
--  Dependencies: 
--   OC_CONF_DATPART_SINIESTROS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONF_DATPART_SINIESTROS FOR SICAS_OC.OC_CONF_DATPART_SINIESTROS
/


GRANT EXECUTE ON SICAS_OC.OC_CONF_DATPART_SINIESTROS TO PUBLIC
/
