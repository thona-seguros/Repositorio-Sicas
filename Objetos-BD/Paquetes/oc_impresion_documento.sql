...
--
-- OC_IMPRESION_DOCUMENTO  (Synonym) 
--
--  Dependencies: 
--   OC_IMPRESION_DOCUMENTO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_IMPRESION_DOCUMENTO FOR SICAS_OC.OC_IMPRESION_DOCUMENTO
/


GRANT EXECUTE ON SICAS_OC.OC_IMPRESION_DOCUMENTO TO PUBLIC
/
