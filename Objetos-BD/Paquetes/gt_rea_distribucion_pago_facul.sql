...
--
-- GT_REA_DISTRIBUCION_PAGO_FACUL  (Synonym) 
--
--  Dependencies: 
--   GT_REA_DISTRIBUCION_PAGO_FACUL (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_REA_DISTRIBUCION_PAGO_FACUL FOR SICAS_OC.GT_REA_DISTRIBUCION_PAGO_FACUL
/


GRANT EXECUTE ON SICAS_OC.GT_REA_DISTRIBUCION_PAGO_FACUL TO PUBLIC
/
