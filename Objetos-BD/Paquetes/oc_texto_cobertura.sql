...
--   TEXTO_COBERTURA (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.oc_texto_cobertura IS
...
--
-- OC_TEXTO_COBERTURA  (Package Body) 
--
--  Dependencies: 
--   OC_TEXTO_COBERTURA (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.oc_texto_cobertura IS
...
--
-- OC_TEXTO_COBERTURA  (Synonym) 
--
--  Dependencies: 
--   OC_TEXTO_COBERTURA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_TEXTO_COBERTURA FOR SICAS_OC.OC_TEXTO_COBERTURA
/


GRANT EXECUTE ON SICAS_OC.OC_TEXTO_COBERTURA TO PUBLIC
/
