...
--   PROVEEDORES (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_PROVEEDORES IS
  --
...
--
-- OC_PROVEEDORES  (Package Body) 
--
--  Dependencies: 
--   OC_PROVEEDORES (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.oc_proveedores IS
--
--
--
...
--
-- OC_PROVEEDORES  (Synonym) 
--
--  Dependencies: 
--   OC_PROVEEDORES (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_PROVEEDORES FOR SICAS_OC.OC_PROVEEDORES
/


GRANT EXECUTE ON SICAS_OC.OC_PROVEEDORES TO PUBLIC
/
