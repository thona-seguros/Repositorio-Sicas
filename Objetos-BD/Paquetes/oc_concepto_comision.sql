...
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_CONCEPTO_COMISION IS
...
--
-- OC_CONCEPTO_COMISION  (Package Body) 
--
--  Dependencies: 
--   OC_CONCEPTO_COMISION (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_CONCEPTO_COMISION IS
...
--
-- OC_CONCEPTO_COMISION  (Synonym) 
--
--  Dependencies: 
--   OC_CONCEPTO_COMISION (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONCEPTO_COMISION FOR SICAS_OC.OC_CONCEPTO_COMISION
/


GRANT EXECUTE ON SICAS_OC.OC_CONCEPTO_COMISION TO PUBLIC
/
