...
--
-- OC_AGENTES_TIPOS_SEGUROS  (Synonym) 
--
--  Dependencies: 
--   OC_AGENTES_TIPOS_SEGUROS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_AGENTES_TIPOS_SEGUROS FOR SICAS_OC.OC_AGENTES_TIPOS_SEGUROS
/


GRANT EXECUTE ON SICAS_OC.OC_AGENTES_TIPOS_SEGUROS TO PUBLIC
/
