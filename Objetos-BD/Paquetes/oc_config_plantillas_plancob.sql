...
--
-- OC_CONFIG_PLANTILLAS_PLANCOB  (Synonym) 
--
--  Dependencies: 
--   OC_CONFIG_PLANTILLAS_PLANCOB (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONFIG_PLANTILLAS_PLANCOB FOR SICAS_OC.OC_CONFIG_PLANTILLAS_PLANCOB
/


GRANT EXECUTE ON SICAS_OC.OC_CONFIG_PLANTILLAS_PLANCOB TO PUBLIC
/
