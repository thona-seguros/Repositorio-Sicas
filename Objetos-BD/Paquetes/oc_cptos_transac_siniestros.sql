...
--
-- OC_CPTOS_TRANSAC_SINIESTROS  (Synonym) 
--
--  Dependencies: 
--   OC_CPTOS_TRANSAC_SINIESTROS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CPTOS_TRANSAC_SINIESTROS FOR SICAS_OC.OC_CPTOS_TRANSAC_SINIESTROS
/


GRANT EXECUTE ON SICAS_OC.OC_CPTOS_TRANSAC_SINIESTROS TO PUBLIC
/
