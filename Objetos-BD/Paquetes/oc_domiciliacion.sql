...
--    UNION
--   SELECT FAC.*,MDC.*,DDR.CodResultado,DDR.RespDomiciliacion,DDR.DescRespDomiciliacion
--     FROM FACTURAS FAC, CLIENTES CL, PERSONA_NATURAL_JURIDICA PNJ, 
--          MEDIOS_DE_COBRO MDC, DET_DOMICI_REC DDR
--    WHERE FAC.CodCliente              = CL.CodCliente
--      AND PNJ.Tipo_Doc_Identificacion = CL.Tipo_Doc_Identificacion
--      AND PNJ.Num_Doc_Identificacion  = CL.Num_Doc_Identificacion
--      AND MDC.Tipo_Doc_Identificacion = PNJ.Tipo_Doc_Identificacion
--      AND MDC.Num_Doc_Identificacion  = PNJ.Num_Doc_Identificacion
--      AND FAC.IdFactura               = DDR.NumRefContrato
--      AND FAC.FecVenc                <= dFecha
--      AND DDR.Tipo_Configuracion      = cTipo_Configuracion
--      AND (MDC.CodFormaCobro          = 'CTC'
--      AND cTipo_Configuracion        = 'D')
--      AND FAC.StsFact                 = 'EMI' 
--      AND NVL(FAC.IndDomiciliado,'N') = 'S'
--      AND OC_FACTURAS.INTENTOS_COBRANZA_CUMPLIDOS(FAC.IdFactura,FAC.CodCia) = 'N'                                                     
--      AND MDC.IdFormaCobro            = (SELECT NVL(IdFormaCobro,1)
--                                           FROM POLIZAS
--                                          WHERE CodCia   = FAC.CodCia
--                                            AND IdPoliza = FAC.IdPoliza)
--      AND GT_CAT_RESPUESTA_WEBTRANSFER.PERMITE_REENVIO (FAC.CodCia, 
--                                                        OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), 
--                                                        OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)),
--                                                        CodResultado,
--                                                        GT_CAT_RESPUESTA_WEBTRANSFER.TIPO_RESPUESTA (FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso),OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)), CodResultado)) = 'S'
--      AND GT_CAT_RESPUESTA_WEBTRANSFER.PERMITE_INTERVALOS (FAC.CodCia, 
--                                                           OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), 
--                                                           OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)),
--                                                           CodResultado,
--                                                           GT_CAT_RESPUESTA_WEBTRANSFER.TIPO_RESPUESTA (FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso),OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)), CodResultado)) = 'N'
--      AND (SYSDATE - GT_CAT_RESPUESTA_WEBTRANSFER.DIAS_REENVIO (FAC.CodCia, 
--                                                                OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), 
--                                                                OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)),
--                                                                CodResultado,
--                                                                GT_CAT_RESPUESTA_WEBTRANSFER.TIPO_RESPUESTA (FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso),OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)), CodResultado))) >= GT_DETALLE_DOMICI_REFERE.FEC_ULTIMO_INTENTO(FAC.CodCia,FAC.IdFactura)   
--    UNION
--   SELECT FAC.*,MDC.*,DDR.CodResultado,DDR.RespDomiciliacion,DDR.DescRespDomiciliacion
--     FROM FACTURAS FAC, CLIENTES CL, PERSONA_NATURAL_JURIDICA PNJ, 
--          MEDIOS_DE_COBRO MDC, DET_DOMICI_REC DDR
...
--                                                             CodResultado,
--                                                             GT_CAT_RESPUESTA_WEBTRANSFER.TIPO_RESPUESTA (FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso),OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)), CodResultado)) = 'S'
--          AND OC_FACTURAS.NUM_INTENTOS_COBRA_REALIZADOS(FAC.IdPoliza,FAC.CodCia) < GT_CAT_RESPUESTA_WEBTRANSFER.REINTENTOS_INTERVALO (FAC.CodCia, 
--                                                                                                                                      OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), 
--                                                                                                                                      OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)),
--                                                                                                                                      CodResultado,
--                                                                                                                                      GT_CAT_RESPUESTA_WEBTRANSFER.TIPO_RESPUESTA (FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso),OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)), CodResultado))
--          AND SYSDATE-(GT_CAT_RESPUESTA_WEBTRANSFER.HORAS_INTERVALO (FAC.CodCia, 
--                                                                     OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), 
--                                                                     OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)),
--                                                                     CodResultado,
--                                                                     GT_CAT_RESPUESTA_WEBTRANSFER.TIPO_RESPUESTA (FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso),OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)), CodResultado))/24) >= GT_DETALLE_DOMICI_REFERE.FEC_ULTIMO_INTENTO(FAC.CodCia,FAC.IdFactura))
--     OR (SYSDATE - GT_CAT_RESPUESTA_WEBTRANSFER.DIAS_REENVIO (FAC.CodCia, 
--                                                              OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), 
--                                                              OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)),
--                                                              CodResultado,
--                                                              GT_CAT_RESPUESTA_WEBTRANSFER.TIPO_RESPUESTA (FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso),OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)), CodResultado))) >= GT_DETALLE_DOMICI_REFERE.FEC_ULTIMO_INTENTO(FAC.CodCia,FAC.IdFactura))
...
--      AND FAC.FecVenc                <= dFecha
--      AND DDR.Tipo_Configuracion      = cTipo_Configuracion
--      AND (MDC.CodFormaCobro         IN ('DOMI','CLAB')
--      AND cTipo_Configuracion        = 'T')
--      AND FAC.StsFact                 = 'EMI' 
--      AND NVL(FAC.IndDomiciliado,'N') = 'S'
--      AND OC_FACTURAS.INTENTOS_COBRANZA_CUMPLIDOS(FAC.IdFactura,FAC.CodCia) = 'N'
...
--                                          WHERE CodCia   = FAC.CodCia
--                                            AND IdPoliza = FAC.IdPoliza)
--      AND (GT_CAT_RESPUESTA_DOMICI.PERMITE_REINTENTOS(FAC.CodCia, 
--                                                      OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), 
--                                                      OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)),
--                                                     DDR.RespDomiciliacion, DDR.DescRespDomiciliacion) = 'S'
--      AND GT_CAT_RESPUESTA_DOMICI.MAXIMO_REINTENTOS(FAC.CodCia, 
--                                                    OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), 
--                                                    OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)),
--                                                    DDR.RespDomiciliacion, DDR.DescRespDomiciliacion) >= OC_FACTURAS.NUM_INTENTOS_COBRA_REALIZADOS(FAC.IdFactura, FAC.CodCia)
--      AND (SYSDATE - GT_CAT_RESPUESTA_DOMICI.DIAS_REINTENTOS(FAC.CodCia, 
--                                                             OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), 
--                                                             OC_CONFIGURACION_DOMICILIACION.CORRELATIVO(FAC.CodCia, OC_DOMICILIACION.CODIGO_ENTIDAD(FAC.CodCia,DDR.IdProceso), OC_DOMICILIACION.TIPO_PROCESO(FAC.CodCia,DDR.IdProceso)),
--                                                             DDR.RespDomiciliacion, DDR.DescRespDomiciliacion)) <= GT_DETALLE_DOMICI_REFERE.FEC_ULTIMO_INTENTO(FAC.CodCia,FAC.IdFactura) 
--          );   
BEGIN
   ...
   FOR D IN C_FACTURAS_VENCIDAS_DET LOOP
      ...
      nMonto         := NVL(D.Monto_Fact_Local,0) + NVL(nAporteFondo,0) + NVL(nPrimaNivelada,0); 
