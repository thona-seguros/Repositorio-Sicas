...
--
-- GT_CONFIG_PLANTILLAS_TABLAS  (Synonym) 
--
--  Dependencies: 
--   GT_CONFIG_PLANTILLAS_TABLAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_CONFIG_PLANTILLAS_TABLAS FOR SICAS_OC.GT_CONFIG_PLANTILLAS_TABLAS
/


GRANT EXECUTE ON SICAS_OC.GT_CONFIG_PLANTILLAS_TABLAS TO PUBLIC
/
