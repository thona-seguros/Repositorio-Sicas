...
--
-- OC_CORREOS_ELECTRONICOS_PNJ  (Synonym) 
--
--  Dependencies: 
--   OC_CORREOS_ELECTRONICOS_PNJ (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CORREOS_ELECTRONICOS_PNJ FOR SICAS_OC.OC_CORREOS_ELECTRONICOS_PNJ
/


GRANT EXECUTE ON SICAS_OC.OC_CORREOS_ELECTRONICOS_PNJ TO PUBLIC
/
