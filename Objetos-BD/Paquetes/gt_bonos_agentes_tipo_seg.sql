...
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_BONOS_AGENTES_TIPO_SEG AS
...
--
-- GT_BONOS_AGENTES_TIPO_SEG  (Package Body) 
--
--  Dependencies: 
--   GT_BONOS_AGENTES_TIPO_SEG (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_BONOS_AGENTES_TIPO_SEG AS
...
--
-- GT_BONOS_AGENTES_TIPO_SEG  (Synonym) 
--
--  Dependencies: 
--   GT_BONOS_AGENTES_TIPO_SEG (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_BONOS_AGENTES_TIPO_SEG FOR SICAS_OC.GT_BONOS_AGENTES_TIPO_SEG
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_BONOS_AGENTES_TIPO_SEG TO PUBLIC
/
