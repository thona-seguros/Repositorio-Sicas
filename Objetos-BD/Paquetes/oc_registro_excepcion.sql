...
--
-- OC_REGISTRO_EXCEPCION  (Synonym) 
--
--  Dependencies: 
--   OC_REGISTRO_EXCEPCION (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_REGISTRO_EXCEPCION FOR SICAS_OC.OC_REGISTRO_EXCEPCION
/


GRANT EXECUTE ON SICAS_OC.OC_REGISTRO_EXCEPCION TO PUBLIC
/
