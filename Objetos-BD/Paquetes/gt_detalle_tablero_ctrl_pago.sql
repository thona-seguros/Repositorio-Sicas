...
--
-- GT_DETALLE_TABLERO_CTRL_PAGO  (Synonym) 
--
--  Dependencies: 
--   GT_DETALLE_TABLERO_CTRL_PAGO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_DETALLE_TABLERO_CTRL_PAGO FOR SICAS_OC.GT_DETALLE_TABLERO_CTRL_PAGO
/


GRANT EXECUTE ON SICAS_OC.GT_DETALLE_TABLERO_CTRL_PAGO TO PUBLIC
/
