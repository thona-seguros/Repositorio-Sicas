...
--
-- OC_PRIMAS_DEPOSITO  (Synonym) 
--
--  Dependencies: 
--   OC_PRIMAS_DEPOSITO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_PRIMAS_DEPOSITO FOR SICAS_OC.OC_PRIMAS_DEPOSITO
/


GRANT EXECUTE ON SICAS_OC.OC_PRIMAS_DEPOSITO TO PUBLIC
/
