...
--   SQ_IDNUMSEGUI (Sequence)
--   SEGUIMIENTO (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_SEGUIMIENTO IS
...
--
-- OC_SEGUIMIENTO  (Package Body) 
--
--  Dependencies: 
--   OC_SEGUIMIENTO (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_SEGUIMIENTO IS
...
--
-- OC_SEGUIMIENTO  (Synonym) 
--
--  Dependencies: 
--   OC_SEGUIMIENTO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_SEGUIMIENTO FOR SICAS_OC.OC_SEGUIMIENTO
/


GRANT EXECUTE ON SICAS_OC.OC_SEGUIMIENTO TO PUBLIC
/
