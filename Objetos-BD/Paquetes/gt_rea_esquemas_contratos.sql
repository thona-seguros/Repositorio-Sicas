...
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_REA_ESQUEMAS_CONTRATOS IS
...
--
-- GT_REA_ESQUEMAS_CONTRATOS  (Package Body) 
--
--  Dependencies: 
--   GT_REA_ESQUEMAS_CONTRATOS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_REA_ESQUEMAS_CONTRATOS IS
...
--
-- GT_REA_ESQUEMAS_CONTRATOS  (Synonym) 
--
--  Dependencies: 
--   GT_REA_ESQUEMAS_CONTRATOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_REA_ESQUEMAS_CONTRATOS FOR SICAS_OC.GT_REA_ESQUEMAS_CONTRATOS
/


GRANT EXECUTE ON SICAS_OC.GT_REA_ESQUEMAS_CONTRATOS TO PUBLIC
/
