...
--
-- OC_DETALLE_COMISION  (Synonym) 
--
--  Dependencies: 
--   OC_DETALLE_COMISION (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_DETALLE_COMISION FOR SICAS_OC.OC_DETALLE_COMISION
/


GRANT EXECUTE ON SICAS_OC.OC_DETALLE_COMISION TO PUBLIC
/
