...
--
-- OC_RESERVAS_TECNICAS_IBNR  (Synonym) 
--
--  Dependencies: 
--   OC_RESERVAS_TECNICAS_IBNR (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_RESERVAS_TECNICAS_IBNR FOR SICAS_OC.OC_RESERVAS_TECNICAS_IBNR
/


GRANT EXECUTE ON SICAS_OC.OC_RESERVAS_TECNICAS_IBNR TO PUBLIC
/
