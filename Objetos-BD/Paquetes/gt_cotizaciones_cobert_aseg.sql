...
--
-- GT_COTIZACIONES_COBERT_ASEG  (Synonym) 
--
--  Dependencies: 
--   GT_COTIZACIONES_COBERT_ASEG (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_COTIZACIONES_COBERT_ASEG FOR SICAS_OC.GT_COTIZACIONES_COBERT_ASEG
/


GRANT EXECUTE ON SICAS_OC.GT_COTIZACIONES_COBERT_ASEG TO PUBLIC
/
