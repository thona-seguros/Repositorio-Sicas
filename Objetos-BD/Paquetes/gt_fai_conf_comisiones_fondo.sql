...
--
-- GT_FAI_CONF_COMISIONES_FONDO  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_CONF_COMISIONES_FONDO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_CONF_COMISIONES_FONDO FOR SICAS_OC.GT_FAI_CONF_COMISIONES_FONDO
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_CONF_COMISIONES_FONDO TO PUBLIC
/
