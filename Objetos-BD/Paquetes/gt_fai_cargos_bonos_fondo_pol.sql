...
--   FAI_CARGOS_BONOS_FONDO_POL (Table)
...
--   TRANSACCION (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_FAI_CARGOS_BONOS_FONDO_POL AS
...
--
-- GT_FAI_CARGOS_BONOS_FONDO_POL  (Package Body) 
--
--  Dependencies: 
--   GT_FAI_CARGOS_BONOS_FONDO_POL (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_FAI_CARGOS_BONOS_FONDO_POL AS
...
--
-- GT_FAI_CARGOS_BONOS_FONDO_POL  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_CARGOS_BONOS_FONDO_POL (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_CARGOS_BONOS_FONDO_POL FOR SICAS_OC.GT_FAI_CARGOS_BONOS_FONDO_POL
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_CARGOS_BONOS_FONDO_POL TO PUBLIC
/
