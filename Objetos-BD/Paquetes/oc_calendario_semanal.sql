...
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_CALENDARIO_SEMANAL IS
...
--
-- OC_CALENDARIO_SEMANAL  (Package Body) 
--
--  Dependencies: 
--   OC_CALENDARIO_SEMANAL (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_CALENDARIO_SEMANAL IS
...
--
-- OC_CALENDARIO_SEMANAL  (Synonym) 
--
--  Dependencies: 
--   OC_CALENDARIO_SEMANAL (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CALENDARIO_SEMANAL FOR SICAS_OC.OC_CALENDARIO_SEMANAL
/


GRANT EXECUTE ON SICAS_OC.OC_CALENDARIO_SEMANAL TO PUBLIC
/
