...
--   T_EDO_CTA_FONDOS (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.TH_T_EDOCTAFONDOS IS
...
--
-- TH_T_EDOCTAFONDOS  (Package Body) 
--
--  Dependencies: 
--   TH_T_EDOCTAFONDOS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.TH_T_EDOCTAFONDOS IS
---
...
--
-- TH_T_EDOCTAFONDOS  (Synonym) 
--
--  Dependencies: 
--   TH_T_EDOCTAFONDOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM TH_T_EDOCTAFONDOS FOR SICAS_OC.TH_T_EDOCTAFONDOS
/


GRANT EXECUTE ON SICAS_OC.TH_T_EDOCTAFONDOS TO PUBLIC
/
