...
--
-- OC_DETALLE_FACTURA_EXTERNA  (Synonym) 
--
--  Dependencies: 
--   OC_DETALLE_FACTURA_EXTERNA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_DETALLE_FACTURA_EXTERNA FOR SICAS_OC.OC_DETALLE_FACTURA_EXTERNA
/


GRANT EXECUTE ON SICAS_OC.OC_DETALLE_FACTURA_EXTERNA TO PUBLIC
/
