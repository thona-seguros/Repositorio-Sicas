...
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_FACT_ELECT_SERIES_FOLIOS IS
...
--
-- OC_FACT_ELECT_SERIES_FOLIOS  (Package Body) 
--
--  Dependencies: 
--   OC_FACT_ELECT_SERIES_FOLIOS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_FACT_ELECT_SERIES_FOLIOS IS
...
--
-- OC_FACT_ELECT_SERIES_FOLIOS  (Synonym) 
--
--  Dependencies: 
--   OC_FACT_ELECT_SERIES_FOLIOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_FACT_ELECT_SERIES_FOLIOS FOR SICAS_OC.OC_FACT_ELECT_SERIES_FOLIOS
/


GRANT EXECUTE ON SICAS_OC.OC_FACT_ELECT_SERIES_FOLIOS TO PUBLIC
/
