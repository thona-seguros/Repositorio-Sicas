--
-- GT_FAI_PLAN_PAGO_RETIRO_FALLEC  (Package) 
--
--  Dependencies: 
--   STANDARD (Package)
--   STANDARD (Package)
...
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_FAI_PLAN_PAGO_RETIRO_FALLEC AS
...
--
-- GT_FAI_PLAN_PAGO_RETIRO_FALLEC  (Package Body) 
--
--  Dependencies: 
--   GT_FAI_PLAN_PAGO_RETIRO_FALLEC (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_FAI_PLAN_PAGO_RETIRO_FALLEC AS
...
--
-- GT_FAI_PLAN_PAGO_RETIRO_FALLEC  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_PLAN_PAGO_RETIRO_FALLEC (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_PLAN_PAGO_RETIRO_FALLEC FOR SICAS_OC.GT_FAI_PLAN_PAGO_RETIRO_FALLEC
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_PLAN_PAGO_RETIRO_FALLEC TO PUBLIC
/
