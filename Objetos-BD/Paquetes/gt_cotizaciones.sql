...
CURSOR COTIZ_Q IS
  SELECT CodCotizador, NumUnicoCotizacion, NumCotizacionRef, FecIniVigCot, FecFinVigCot,
         ...
         IdTipoSeg, PlanCob,FECSOLICITUD, CODEMPRESA, CODCIA
    FROM COTIZACIONES c
   WHERE CodCia        = nCodCia
     AND CodEmpresa    = nCodEmpresa
     AND IdCotizacion  = nIdCotizacion
       ...
       END IF;       
         ...
         UPDATE POLIZAS
            SET CODCIA                =      X.CODCIA,
                ...
                FECSOLICITUD          =      X.FECSOLICITUD,
                FECEMISION            =      TRUNC(SYSDATE),
                STSPOLIZA             =      'SOL',
