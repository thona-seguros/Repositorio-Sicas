...
--   BONOS_AGENTES_RANGOS_CONV (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_BONOS_AGENTES_RANGOS_CONV AS
...
--
-- GT_BONOS_AGENTES_RANGOS_CONV  (Package Body) 
--
--  Dependencies: 
--   GT_BONOS_AGENTES_RANGOS_CONV (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_BONOS_AGENTES_RANGOS_CONV AS
...
--
-- GT_BONOS_AGENTES_RANGOS_CONV  (Synonym) 
--
--  Dependencies: 
--   GT_BONOS_AGENTES_RANGOS_CONV (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_BONOS_AGENTES_RANGOS_CONV FOR SICAS_OC.GT_BONOS_AGENTES_RANGOS_CONV
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_BONOS_AGENTES_RANGOS_CONV TO PUBLIC
/
