...
cUsuario          OBSERVACION_SINIESTRO.CODUSUARIO%TYPE; --PST 27/11/2023
BEGIN
...
--   VALUES (nIdSiniestro, nIdPoliza, nIdObserva, dFechaCamb, USER, cObservacion);
   VALUES (nIdSiniestro, nIdPoliza, nIdObserva, dFechaCamb, cUsuario, cObservacion); --PST 27-11-2023 CAMBIO EN INSERT
