...
--
-- OC_FACT_ELECT_CAT_GPO_LINEA  (Synonym) 
--
--  Dependencies: 
--   OC_FACT_ELECT_CAT_GPO_LINEA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_FACT_ELECT_CAT_GPO_LINEA FOR SICAS_OC.OC_FACT_ELECT_CAT_GPO_LINEA
/


GRANT EXECUTE ON SICAS_OC.OC_FACT_ELECT_CAT_GPO_LINEA TO PUBLIC
/
