...
--
-- GT_BONOS_AGENTES_PROY_FACT  (Synonym) 
--
--  Dependencies: 
--   GT_BONOS_AGENTES_PROY_FACT (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_BONOS_AGENTES_PROY_FACT FOR SICAS_OC.GT_BONOS_AGENTES_PROY_FACT
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_BONOS_AGENTES_PROY_FACT TO PUBLIC
/
