...
--
-- OC_AGENTES_CEDULA_AUTORIZADA  (Synonym) 
--
--  Dependencies: 
--   OC_AGENTES_CEDULA_AUTORIZADA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_AGENTES_CEDULA_AUTORIZADA FOR SICAS_OC.OC_AGENTES_CEDULA_AUTORIZADA
/


GRANT EXECUTE ON SICAS_OC.OC_AGENTES_CEDULA_AUTORIZADA TO PUBLIC
/
