...
--
-- GT_AUTORIZA_PROCESOS_REGRESO  (Synonym) 
--
--  Dependencies: 
--   GT_AUTORIZA_PROCESOS_REGRESO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_AUTORIZA_PROCESOS_REGRESO FOR SICAS_OC.GT_AUTORIZA_PROCESOS_REGRESO
/


GRANT EXECUTE ON SICAS_OC.GT_AUTORIZA_PROCESOS_REGRESO TO PUBLIC
/
