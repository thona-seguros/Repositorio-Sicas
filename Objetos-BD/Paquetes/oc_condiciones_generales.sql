...
--
-- OC_CONDICIONES_GENERALES  (Synonym) 
--
--  Dependencies: 
--   OC_CONDICIONES_GENERALES (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONDICIONES_GENERALES FOR SICAS_OC.OC_CONDICIONES_GENERALES
/


GRANT EXECUTE ON SICAS_OC.OC_CONDICIONES_GENERALES TO PUBLIC
/
