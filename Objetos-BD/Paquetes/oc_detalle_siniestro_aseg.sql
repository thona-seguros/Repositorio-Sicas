...
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_DETALLE_SINIESTRO_ASEG IS
...
--
-- OC_DETALLE_SINIESTRO_ASEG  (Package Body) 
--
--  Dependencies: 
--   OC_DETALLE_SINIESTRO_ASEG (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_DETALLE_SINIESTRO_ASEG IS
--
...
--
-- OC_DETALLE_SINIESTRO_ASEG  (Synonym) 
--
--  Dependencies: 
--   OC_DETALLE_SINIESTRO_ASEG (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_DETALLE_SINIESTRO_ASEG FOR SICAS_OC.OC_DETALLE_SINIESTRO_ASEG
/


GRANT EXECUTE ON SICAS_OC.OC_DETALLE_SINIESTRO_ASEG TO PUBLIC
/
