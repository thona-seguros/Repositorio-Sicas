...
--   BINES_TARJETA (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_BINES_TARJETA IS
  --
...
--
-- OC_BINES_TARJETA  (Package Body) 
--
--  Dependencies: 
--   OC_BINES_TARJETA (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_BINES_TARJETA IS
  --
...
--
-- OC_BINES_TARJETA  (Synonym) 
--
--  Dependencies: 
--   OC_BINES_TARJETA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_BINES_TARJETA FOR SICAS_OC.OC_BINES_TARJETA
/


GRANT EXECUTE ON SICAS_OC.OC_BINES_TARJETA TO PUBLIC
/
