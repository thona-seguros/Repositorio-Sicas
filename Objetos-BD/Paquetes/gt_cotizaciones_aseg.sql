...
--
-- GT_COTIZACIONES_ASEG  (Synonym) 
--
--  Dependencies: 
--   GT_COTIZACIONES_ASEG (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_COTIZACIONES_ASEG FOR SICAS_OC.GT_COTIZACIONES_ASEG
/


GRANT EXECUTE ON SICAS_OC.GT_COTIZACIONES_ASEG TO PUBLIC
/
