...
--
-- OC_ASISTENCIAS_DETALLE_POLIZA  (Synonym) 
--
--  Dependencies: 
--   OC_ASISTENCIAS_DETALLE_POLIZA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_ASISTENCIAS_DETALLE_POLIZA FOR SICAS_OC.OC_ASISTENCIAS_DETALLE_POLIZA
/


GRANT EXECUTE ON SICAS_OC.OC_ASISTENCIAS_DETALLE_POLIZA TO PUBLIC
/
