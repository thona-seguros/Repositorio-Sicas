...
--
-- OC_NOTAS_DE_CREDITO_APLICACION  (Synonym) 
--
--  Dependencies: 
--   OC_NOTAS_DE_CREDITO_APLICACION (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_NOTAS_DE_CREDITO_APLICACION FOR SICAS_OC.OC_NOTAS_DE_CREDITO_APLICACION
/


GRANT EXECUTE ON SICAS_OC.OC_NOTAS_DE_CREDITO_APLICACION TO PUBLIC
/
