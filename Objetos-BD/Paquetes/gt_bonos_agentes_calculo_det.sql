...
--   TIPO_AGENTE (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_BONOS_AGENTES_CALCULO_DET AS
...
--
-- GT_BONOS_AGENTES_CALCULO_DET  (Package Body) 
--
--  Dependencies: 
--   GT_BONOS_AGENTES_CALCULO_DET (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_BONOS_AGENTES_CALCULO_DET AS
   PROCEDURE INSERTAR(nCodCia NUMBER, nCodEmpresa NUMBER, nIdBonoVentas NUMBER, nCodNivel NUMBER,
                      cCodAgente VARCHAR2, dFecIniCalcBono DATE, dFecFinCalcBono DATE, cCodConcepto VARCHAR2,
...
--
-- GT_BONOS_AGENTES_CALCULO_DET  (Synonym) 
--
--  Dependencies: 
--   GT_BONOS_AGENTES_CALCULO_DET (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_BONOS_AGENTES_CALCULO_DET FOR SICAS_OC.GT_BONOS_AGENTES_CALCULO_DET
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_BONOS_AGENTES_CALCULO_DET TO PUBLIC
/
