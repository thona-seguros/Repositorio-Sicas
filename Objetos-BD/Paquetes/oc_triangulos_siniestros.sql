...
--
-- OC_TRIANGULOS_SINIESTROS  (Synonym) 
--
--  Dependencies: 
--   OC_TRIANGULOS_SINIESTROS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_TRIANGULOS_SINIESTROS FOR SICAS_OC.OC_TRIANGULOS_SINIESTROS
/


GRANT EXECUTE ON SICAS_OC.OC_TRIANGULOS_SINIESTROS TO PUBLIC
/
