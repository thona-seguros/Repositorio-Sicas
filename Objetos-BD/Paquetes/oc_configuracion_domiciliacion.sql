...
--
-- OC_CONFIGURACION_DOMICILIACION  (Synonym) 
--
--  Dependencies: 
--   OC_CONFIGURACION_DOMICILIACION (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONFIGURACION_DOMICILIACION FOR SICAS_OC.OC_CONFIGURACION_DOMICILIACION
/


GRANT EXECUTE ON SICAS_OC.OC_CONFIGURACION_DOMICILIACION TO PUBLIC
/
