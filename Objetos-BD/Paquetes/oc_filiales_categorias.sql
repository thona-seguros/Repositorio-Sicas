...
--
-- OC_FILIALES_CATEGORIAS  (Synonym) 
--
--  Dependencies: 
--   OC_FILIALES_CATEGORIAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_FILIALES_CATEGORIAS FOR SICAS_OC.OC_FILIALES_CATEGORIAS
/


GRANT EXECUTE ON SICAS_OC.OC_FILIALES_CATEGORIAS TO PUBLIC
/
