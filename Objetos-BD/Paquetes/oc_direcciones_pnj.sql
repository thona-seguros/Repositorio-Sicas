...
--
-- OC_DIRECCIONES_PNJ  (Synonym) 
--
--  Dependencies: 
--   OC_DIRECCIONES_PNJ (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_DIRECCIONES_PNJ FOR SICAS_OC.OC_DIRECCIONES_PNJ
/


GRANT EXECUTE ON SICAS_OC.OC_DIRECCIONES_PNJ TO PUBLIC
/
