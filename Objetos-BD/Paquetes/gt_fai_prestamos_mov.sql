...
--
-- GT_FAI_PRESTAMOS_MOV  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_PRESTAMOS_MOV (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_PRESTAMOS_MOV FOR SICAS_OC.GT_FAI_PRESTAMOS_MOV
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_PRESTAMOS_MOV TO PUBLIC
/
