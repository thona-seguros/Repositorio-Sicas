...
--
-- GT_FAI_FONDOS_DETALLE_POLIZA  (Package Body) 
--
--  Dependencies: 
--   GT_FAI_FONDOS_DETALLE_POLIZA (Package)
--
...
--
-- GT_FAI_FONDOS_DETALLE_POLIZA  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_FONDOS_DETALLE_POLIZA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_FONDOS_DETALLE_POLIZA FOR SICAS_OC.GT_FAI_FONDOS_DETALLE_POLIZA
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_FONDOS_DETALLE_POLIZA TO PUBLIC
/
