...
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_REA_ESQUEMAS_EMPRESAS IS
...
--
-- GT_REA_ESQUEMAS_EMPRESAS  (Package Body) 
--
--  Dependencies: 
--   GT_REA_ESQUEMAS_EMPRESAS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_REA_ESQUEMAS_EMPRESAS IS
...
--
-- GT_REA_ESQUEMAS_EMPRESAS  (Synonym) 
--
--  Dependencies: 
--   GT_REA_ESQUEMAS_EMPRESAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_REA_ESQUEMAS_EMPRESAS FOR SICAS_OC.GT_REA_ESQUEMAS_EMPRESAS
/


GRANT EXECUTE ON SICAS_OC.GT_REA_ESQUEMAS_EMPRESAS TO PUBLIC
/
