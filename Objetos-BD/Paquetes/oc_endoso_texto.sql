...
--
-- OC_ENDOSO_TEXTO  (Synonym) 
--
--  Dependencies: 
--   OC_ENDOSO_TEXTO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_ENDOSO_TEXTO FOR SICAS_OC.OC_ENDOSO_TEXTO
/


GRANT EXECUTE ON SICAS_OC.OC_ENDOSO_TEXTO TO PUBLIC
/
