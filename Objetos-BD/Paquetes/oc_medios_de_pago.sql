...
--
-- OC_MEDIOS_DE_PAGO  (Synonym) 
--
--  Dependencies: 
--   OC_MEDIOS_DE_PAGO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_MEDIOS_DE_PAGO FOR SICAS_OC.OC_MEDIOS_DE_PAGO
/


GRANT EXECUTE ON SICAS_OC.OC_MEDIOS_DE_PAGO TO PUBLIC
/
