...
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_CONMUTADOS AS
...
--
-- OC_CONMUTADOS  (Package Body) 
--
--  Dependencies: 
--   OC_CONMUTADOS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_CONMUTADOS AS
...
--
-- OC_CONMUTADOS  (Synonym) 
--
--  Dependencies: 
--   OC_CONMUTADOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONMUTADOS FOR SICAS_OC.OC_CONMUTADOS
/


GRANT EXECUTE ON SICAS_OC.OC_CONMUTADOS TO PUBLIC
/
