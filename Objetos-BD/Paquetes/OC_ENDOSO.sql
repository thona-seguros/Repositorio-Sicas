CREATE OR REPLACE PACKAGE SICAS_OC.OC_ENDOSO IS
  ...
  -- SE CORRIGIO CANCELACION Y REHABILITACION        JICO 20220125 INCI
  --
	...
	*/  -- FIN ENDOINA
	...
	BEGIN
	  ...
	  --    
          ...
          --
          cTexto := replace(cTexto, '01/01/1900', OC_GENERALES.FECHA_EN_LETRAS(dFecAnulacion));
          cTexto := replace(cTexto, '31/12/9999', OC_GENERALES.FECHA_EN_LETRAS(dFecFinVig));
          CLINEA_T := replace(CLINEA_T, '01/01/1900', OC_GENERALES.FECHA_EN_LETRAS(dFecAnulacion));
          CLINEA_T := replace(CLINEA_T, '31/12/9999', OC_GENERALES.FECHA_EN_LETRAS(dFecFinVig));
          --
