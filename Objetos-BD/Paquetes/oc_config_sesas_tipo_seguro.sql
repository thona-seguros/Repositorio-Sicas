...
--
-- OC_CONFIG_SESAS_TIPO_SEGURO  (Synonym) 
--
--  Dependencies: 
--   OC_CONFIG_SESAS_TIPO_SEGURO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONFIG_SESAS_TIPO_SEGURO FOR SICAS_OC.OC_CONFIG_SESAS_TIPO_SEGURO
/


GRANT EXECUTE ON SICAS_OC.OC_CONFIG_SESAS_TIPO_SEGURO TO PUBLIC
/
