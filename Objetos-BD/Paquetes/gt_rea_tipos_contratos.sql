...
--
-- GT_REA_TIPOS_CONTRATOS  (Synonym) 
--
--  Dependencies: 
--   GT_REA_TIPOS_CONTRATOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_REA_TIPOS_CONTRATOS FOR SICAS_OC.GT_REA_TIPOS_CONTRATOS
/


GRANT EXECUTE ON SICAS_OC.GT_REA_TIPOS_CONTRATOS TO PUBLIC
/
