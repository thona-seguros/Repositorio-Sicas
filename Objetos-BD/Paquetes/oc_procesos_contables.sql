...
--
-- OC_PROCESOS_CONTABLES  (Synonym) 
--
--  Dependencies: 
--   OC_PROCESOS_CONTABLES (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_PROCESOS_CONTABLES FOR SICAS_OC.OC_PROCESOS_CONTABLES
/


GRANT EXECUTE ON SICAS_OC.OC_PROCESOS_CONTABLES TO PUBLIC
/
