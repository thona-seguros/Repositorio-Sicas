...
--
-- GT_COTIZADOR_PLANCOB  (Synonym) 
--
--  Dependencies: 
--   GT_COTIZADOR_PLANCOB (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_COTIZADOR_PLANCOB FOR SICAS_OC.GT_COTIZADOR_PLANCOB
/


GRANT EXECUTE ON SICAS_OC.GT_COTIZADOR_PLANCOB TO PUBLIC
/
