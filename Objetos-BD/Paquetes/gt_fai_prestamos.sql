...
--   TRANSACCION (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_FAI_PRESTAMOS AS
...
--
-- GT_FAI_PRESTAMOS  (Package Body) 
--
--  Dependencies: 
--   GT_FAI_PRESTAMOS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_FAI_PRESTAMOS AS
...
--
-- GT_FAI_PRESTAMOS  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_PRESTAMOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_PRESTAMOS FOR SICAS_OC.GT_FAI_PRESTAMOS
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_PRESTAMOS TO PUBLIC
/
