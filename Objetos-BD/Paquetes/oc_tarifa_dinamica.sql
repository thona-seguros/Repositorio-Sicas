...
--
CREATE OR REPLACE PACKAGE SICAS_OC.oc_tarifa_dinamica IS
...
--
-- OC_TARIFA_DINAMICA  (Package Body) 
--
--  Dependencies: 
--   OC_TARIFA_DINAMICA (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.oc_tarifa_dinamica IS
...
--
-- OC_TARIFA_DINAMICA  (Synonym) 
--
--  Dependencies: 
--   OC_TARIFA_DINAMICA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_TARIFA_DINAMICA FOR SICAS_OC.OC_TARIFA_DINAMICA
/


GRANT EXECUTE ON SICAS_OC.OC_TARIFA_DINAMICA TO PUBLIC
/
