...
-- BITACORA DE CAMBIOS
--
-- HOMOLOGACION DEL PAQUETE A LOS AMBIENTES Y RUTINA DE CLAVE RESICO   --RESICO 20231012
--
...
FUNCTION FUN_CVE_RESICO(PNIVELCTA3 NUMBER) RETURN NUMBER;  --RESICO
...
FUNCTION FUN_CVE_RESICO(PNIVELCTA3 NUMBER) RETURN NUMBER IS  --RESICO
nIDREGFISSAT   CAT_REGIMEN_FISCAL.IDREGFISSAT%TYPE;
BEGIN
SELECT C.IDREGFISSAT
  INTO nIDREGFISSAT
  FROM CAT_REGIMEN_FISCAL C
 WHERE C.NIVELCTA3     = PNIVELCTA3 -- 1 = RESICO
   AND C.STSTIPREGFISC = 'ACT';
  --
  RETURN ( nIDREGFISSAT );
  --
EXCEPTION WHEN OTHERS THEN
