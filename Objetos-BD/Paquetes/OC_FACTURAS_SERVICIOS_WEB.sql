CREATE OR REPLACE PACKAGE SICAS_OC.OC_FACTURAS_SERVICIOS_WEB AS
...
/
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_FACTURAS_SERVICIOS_WEB AS
...
END OC_FACTURAS_SERVICIOS_WEB;
/
GRANT EXECUTE, DEBUG ON SICAS_OC.OC_FACTURAS_SERVICIOS_WEB TO "PUBLIC";
/
