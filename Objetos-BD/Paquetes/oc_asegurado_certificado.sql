...
--
-- OC_ASEGURADO_CERTIFICADO  (Package Body) 
--
--  Dependencies: 
--   OC_ASEGURADO_CERTIFICADO (Package)
--
...
--
-- OC_ASEGURADO_CERTIFICADO  (Synonym) 
--
--  Dependencies: 
--   OC_ASEGURADO_CERTIFICADO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_ASEGURADO_CERTIFICADO FOR SICAS_OC.OC_ASEGURADO_CERTIFICADO
/


GRANT EXECUTE, DEBUG ON SICAS_OC.OC_ASEGURADO_CERTIFICADO TO PUBLIC
/
