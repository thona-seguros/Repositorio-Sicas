...
--
-- OC_AGENTE_POLIZA_T  (Synonym) 
--
--  Dependencies: 
--   OC_AGENTE_POLIZA_T (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_AGENTE_POLIZA_T FOR SICAS_OC.OC_AGENTE_POLIZA_T
/


GRANT EXECUTE ON SICAS_OC.OC_AGENTE_POLIZA_T TO PUBLIC
/
