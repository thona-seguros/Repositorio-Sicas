...
--
-- OC_ASISTENCIAS_ASEGURADO  (Package Body) 
--
--  Dependencies: 
--   OC_ASISTENCIAS_ASEGURADO (Package)
--
...
--
-- OC_ASISTENCIAS_ASEGURADO  (Synonym) 
--
--  Dependencies: 
--   OC_ASISTENCIAS_ASEGURADO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_ASISTENCIAS_ASEGURADO FOR SICAS_OC.OC_ASISTENCIAS_ASEGURADO
/


GRANT EXECUTE ON SICAS_OC.OC_ASISTENCIAS_ASEGURADO TO PUBLIC
/
