...
--
-- GT_REA_DISTRIBUCION_EMPRESAS  (Synonym) 
--
--  Dependencies: 
--   GT_REA_DISTRIBUCION_EMPRESAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_REA_DISTRIBUCION_EMPRESAS FOR SICAS_OC.GT_REA_DISTRIBUCION_EMPRESAS
/


GRANT EXECUTE ON SICAS_OC.GT_REA_DISTRIBUCION_EMPRESAS TO PUBLIC
/
