...
--
-- OC_RESERVAS_TECNICAS_CONTAB  (Synonym) 
--
--  Dependencies: 
--   OC_RESERVAS_TECNICAS_CONTAB (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_RESERVAS_TECNICAS_CONTAB FOR SICAS_OC.OC_RESERVAS_TECNICAS_CONTAB
/


GRANT EXECUTE ON SICAS_OC.OC_RESERVAS_TECNICAS_CONTAB TO PUBLIC
/
