...
--
-- OC_DETALLE_SINIESTRO  (Synonym) 
--
--  Dependencies: 
--   OC_DETALLE_SINIESTRO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_DETALLE_SINIESTRO FOR SICAS_OC.OC_DETALLE_SINIESTRO
/


GRANT EXECUTE ON SICAS_OC.OC_DETALLE_SINIESTRO TO PUBLIC
/
