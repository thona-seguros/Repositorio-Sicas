...
--
-- OC_CONFIG_RESERVAS  (Synonym) 
--
--  Dependencies: 
--   OC_CONFIG_RESERVAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONFIG_RESERVAS FOR SICAS_OC.OC_CONFIG_RESERVAS
/


GRANT EXECUTE ON SICAS_OC.OC_CONFIG_RESERVAS TO PUBLIC
/
