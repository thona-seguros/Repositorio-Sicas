...
--
-- GT_FAI_CARGOS_FONDOS_DET  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_CARGOS_FONDOS_DET (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_CARGOS_FONDOS_DET FOR SICAS_OC.GT_FAI_CARGOS_FONDOS_DET
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_CARGOS_FONDOS_DET TO PUBLIC
/
