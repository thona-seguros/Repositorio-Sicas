...
--
-- OC_PROCESOS_MASIVOS_LOG  (Synonym) 
--
--  Dependencies: 
--   OC_PROCESOS_MASIVOS_LOG (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_PROCESOS_MASIVOS_LOG FOR SICAS_OC.OC_PROCESOS_MASIVOS_LOG
/


GRANT EXECUTE ON SICAS_OC.OC_PROCESOS_MASIVOS_LOG TO PUBLIC
/
