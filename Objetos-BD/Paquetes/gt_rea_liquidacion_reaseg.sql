...
--
-- GT_REA_LIQUIDACION_REASEG  (Synonym) 
--
--  Dependencies: 
--   GT_REA_LIQUIDACION_REASEG (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_REA_LIQUIDACION_REASEG FOR SICAS_OC.GT_REA_LIQUIDACION_REASEG
/


GRANT EXECUTE ON SICAS_OC.GT_REA_LIQUIDACION_REASEG TO PUBLIC
/
