...
--
-- OC_FACT_ELECT_DET_TIMBRE_LOG  (Synonym) 
--
--  Dependencies: 
--   OC_FACT_ELECT_DET_TIMBRE_LOG (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_FACT_ELECT_DET_TIMBRE_LOG FOR SICAS_OC.OC_FACT_ELECT_DET_TIMBRE_LOG
/


GRANT EXECUTE ON SICAS_OC.OC_FACT_ELECT_DET_TIMBRE_LOG TO PUBLIC
/
