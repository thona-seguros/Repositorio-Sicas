...
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_CONFIG_RESERVAS_PLANCOB IS
...
--
-- OC_CONFIG_RESERVAS_PLANCOB  (Package Body) 
--
--  Dependencies: 
--   OC_CONFIG_RESERVAS_PLANCOB (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_CONFIG_RESERVAS_PLANCOB IS
...
--
-- OC_CONFIG_RESERVAS_PLANCOB  (Synonym) 
--
--  Dependencies: 
--   OC_CONFIG_RESERVAS_PLANCOB (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONFIG_RESERVAS_PLANCOB FOR SICAS_OC.OC_CONFIG_RESERVAS_PLANCOB
/


GRANT EXECUTE ON SICAS_OC.OC_CONFIG_RESERVAS_PLANCOB TO PUBLIC
/
