...
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_PERDIDAS_ORGANICAS IS
...
--
-- OC_PERDIDAS_ORGANICAS  (Package Body) 
--
--  Dependencies: 
--   OC_PERDIDAS_ORGANICAS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_PERDIDAS_ORGANICAS IS
...
--
-- OC_PERDIDAS_ORGANICAS  (Synonym) 
--
--  Dependencies: 
--   OC_PERDIDAS_ORGANICAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_PERDIDAS_ORGANICAS FOR SICAS_OC.OC_PERDIDAS_ORGANICAS
/


GRANT EXECUTE ON SICAS_OC.OC_PERDIDAS_ORGANICAS TO PUBLIC
/
