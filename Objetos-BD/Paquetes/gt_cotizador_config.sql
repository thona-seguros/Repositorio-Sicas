...
--
-- GT_COTIZADOR_CONFIG  (Package Body) 
--
--  Dependencies: 
--   GT_COTIZADOR_CONFIG (Package)
--
...
--
-- GT_COTIZADOR_CONFIG  (Synonym) 
--
--  Dependencies: 
--   GT_COTIZADOR_CONFIG (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_COTIZADOR_CONFIG FOR SICAS_OC.GT_COTIZADOR_CONFIG
/


GRANT EXECUTE ON SICAS_OC.GT_COTIZADOR_CONFIG TO PUBLIC
/
