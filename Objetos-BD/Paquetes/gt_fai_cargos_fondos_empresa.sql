...
--
-- GT_FAI_CARGOS_FONDOS_EMPRESA  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_CARGOS_FONDOS_EMPRESA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_CARGOS_FONDOS_EMPRESA FOR SICAS_OC.GT_FAI_CARGOS_FONDOS_EMPRESA
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_CARGOS_FONDOS_EMPRESA TO PUBLIC
/
