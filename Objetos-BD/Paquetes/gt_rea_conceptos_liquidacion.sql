...
--
-- GT_REA_CONCEPTOS_LIQUIDACION  (Synonym) 
--
--  Dependencies: 
--   GT_REA_CONCEPTOS_LIQUIDACION (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_REA_CONCEPTOS_LIQUIDACION FOR SICAS_OC.GT_REA_CONCEPTOS_LIQUIDACION
/


GRANT EXECUTE ON SICAS_OC.GT_REA_CONCEPTOS_LIQUIDACION TO PUBLIC
/
