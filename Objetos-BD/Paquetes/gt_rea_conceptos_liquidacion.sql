...
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_REA_CONCEPTOS_LIQUIDACION IS
...
--
-- GT_REA_CONCEPTOS_LIQUIDACION  (Package Body) 
--
--  Dependencies: 
--   GT_REA_CONCEPTOS_LIQUIDACION (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_REA_CONCEPTOS_LIQUIDACION IS
