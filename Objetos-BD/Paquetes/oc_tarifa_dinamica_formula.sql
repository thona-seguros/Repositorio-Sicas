...
--   TARIFA_DINAMICA_FORMULA (Table)
--   OC_ASEGURADO_CERTIFICADO (Package)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_TARIFA_DINAMICA_FORMULA IS
...
--
-- OC_TARIFA_DINAMICA_FORMULA  (Package Body) 
--
--  Dependencies: 
--   OC_TARIFA_DINAMICA_FORMULA (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_TARIFA_DINAMICA_FORMULA IS
...
--
-- OC_TARIFA_DINAMICA_FORMULA  (Synonym) 
--
--  Dependencies: 
--   OC_TARIFA_DINAMICA_FORMULA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_TARIFA_DINAMICA_FORMULA FOR SICAS_OC.OC_TARIFA_DINAMICA_FORMULA
/


GRANT EXECUTE ON SICAS_OC.OC_TARIFA_DINAMICA_FORMULA TO PUBLIC
/
