...
--   AGENTE_POLIZA (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_AGENTES_DETALLES_POLIZAS IS
...
--
-- OC_AGENTES_DETALLES_POLIZAS  (Package Body) 
--
--  Dependencies: 
--   OC_AGENTES_DETALLES_POLIZAS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_AGENTES_DETALLES_POLIZAS IS
...
--
-- OC_AGENTES_DETALLES_POLIZAS  (Synonym) 
--
--  Dependencies: 
--   OC_AGENTES_DETALLES_POLIZAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_AGENTES_DETALLES_POLIZAS FOR SICAS_OC.OC_AGENTES_DETALLES_POLIZAS
/


GRANT EXECUTE ON SICAS_OC.OC_AGENTES_DETALLES_POLIZAS TO PUBLIC
/
