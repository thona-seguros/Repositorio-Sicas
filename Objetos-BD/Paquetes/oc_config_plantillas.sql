...
--
-- OC_CONFIG_PLANTILLAS  (Synonym) 
--
--  Dependencies: 
--   OC_CONFIG_PLANTILLAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONFIG_PLANTILLAS FOR SICAS_OC.OC_CONFIG_PLANTILLAS
/


GRANT EXECUTE ON SICAS_OC.OC_CONFIG_PLANTILLAS TO PUBLIC
/
