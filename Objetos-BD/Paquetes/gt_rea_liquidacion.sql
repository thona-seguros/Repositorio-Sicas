...
--
-- GT_REA_LIQUIDACION  (Synonym) 
--
--  Dependencies: 
--   GT_REA_LIQUIDACION (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_REA_LIQUIDACION FOR SICAS_OC.GT_REA_LIQUIDACION
/


GRANT EXECUTE ON SICAS_OC.GT_REA_LIQUIDACION TO PUBLIC
/
