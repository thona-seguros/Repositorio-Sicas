...
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_FACTURA_EXTERNA IS
...
--
-- OC_FACTURA_EXTERNA  (Package Body) 
--
--  Dependencies: 
--   OC_FACTURA_EXTERNA (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_FACTURA_EXTERNA IS
...
--
-- OC_FACTURA_EXTERNA  (Synonym) 
--
--  Dependencies: 
--   OC_FACTURA_EXTERNA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_FACTURA_EXTERNA FOR SICAS_OC.OC_FACTURA_EXTERNA
/


GRANT EXECUTE ON SICAS_OC.OC_FACTURA_EXTERNA TO PUBLIC
/
