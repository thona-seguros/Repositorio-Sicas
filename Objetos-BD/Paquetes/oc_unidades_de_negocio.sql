...
--
-- OC_UNIDADES_DE_NEGOCIO  (Synonym) 
--
--  Dependencies: 
--   OC_UNIDADES_DE_NEGOCIO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_UNIDADES_DE_NEGOCIO FOR SICAS_OC.OC_UNIDADES_DE_NEGOCIO
/


GRANT EXECUTE ON SICAS_OC.OC_UNIDADES_DE_NEGOCIO TO PUBLIC
/
