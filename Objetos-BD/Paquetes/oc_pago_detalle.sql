...
--
-- OC_PAGO_DETALLE  (Synonym) 
--
--  Dependencies: 
--   OC_PAGO_DETALLE (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_PAGO_DETALLE FOR SICAS_OC.OC_PAGO_DETALLE
/


GRANT EXECUTE ON SICAS_OC.OC_PAGO_DETALLE TO PUBLIC
/
