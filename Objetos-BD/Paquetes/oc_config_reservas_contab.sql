...
--
-- OC_CONFIG_RESERVAS_CONTAB  (Synonym) 
--
--  Dependencies: 
--   OC_CONFIG_RESERVAS_CONTAB (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONFIG_RESERVAS_CONTAB FOR SICAS_OC.OC_CONFIG_RESERVAS_CONTAB
/


GRANT EXECUTE ON SICAS_OC.OC_CONFIG_RESERVAS_CONTAB TO PUBLIC
/
