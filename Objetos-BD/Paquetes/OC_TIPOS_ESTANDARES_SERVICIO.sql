CREATE OR REPLACE PACKAGE SICAS_OC.OC_TIPOS_ESTANDARES_SERVICIO AS
    --
...
/
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_TIPOS_ESTANDARES_SERVICIO AS
...
END OC_TIPOS_ESTANDARES_SERVICIO;
/
GRANT EXECUTE, DEBUG ON SICAS_OC.OC_TIPOS_ESTANDARES_SERVICIO TO "PUBLIC";
/
CREATE OR REPLACE PUBLIC SYNONYM OC_TIPOS_ESTANDARES_SERVICIO FOR SICAS_OC.OC_TIPOS_ESTANDARES_SERVICIO;
/
