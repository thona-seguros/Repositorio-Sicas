...
--   WSGOC (Package)
--
CREATE OR REPLACE PACKAGE SICAS_OC.WSGMC_OUTPUT1 is
...
--
-- WSGMC_OUTPUT1  (Package Body) 
--
--  Dependencies: 
--   WSGMC_OUTPUT1 (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.WSGMC_OUTPUT1 is
  -- make sure we don't keep this around after a call
  pragma SERIALLY_REUSABLE;
...
--
-- WSGMC_OUTPUT1  (Synonym) 
--
--  Dependencies: 
--   WSGMC_OUTPUT1 (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM WSGMC_OUTPUT1 FOR SICAS_OC.WSGMC_OUTPUT1
/


GRANT EXECUTE ON SICAS_OC.WSGMC_OUTPUT1 TO PUBLIC
/
