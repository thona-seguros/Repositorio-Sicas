...
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_REA_EMPRESAS_GREMIO IS
...
--
-- GT_REA_EMPRESAS_GREMIO  (Package Body) 
--
--  Dependencies: 
--   GT_REA_EMPRESAS_GREMIO (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_REA_EMPRESAS_GREMIO IS
...
--
-- GT_REA_EMPRESAS_GREMIO  (Synonym) 
--
--  Dependencies: 
--   GT_REA_EMPRESAS_GREMIO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_REA_EMPRESAS_GREMIO FOR SICAS_OC.GT_REA_EMPRESAS_GREMIO
/


GRANT EXECUTE ON SICAS_OC.GT_REA_EMPRESAS_GREMIO TO PUBLIC
/
