...
--
-- OC_BENEFICIARIO  (Synonym) 
--
--  Dependencies: 
--   OC_BENEFICIARIO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_BENEFICIARIO FOR SICAS_OC.OC_BENEFICIARIO
/


GRANT EXECUTE ON SICAS_OC.OC_BENEFICIARIO TO PUBLIC
/
