--
-- OC_DIRECCION_REGIONAL_USR  (Package) 
--
--  Dependencies: 
--   STANDARD (Package)
--   STANDARD (Package)
--   DBMS_STANDARD (Package)
--   DIRECCION_REGIONAL_USR (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_DIRECCION_REGIONAL_USR IS
...
--
-- OC_DIRECCION_REGIONAL_USR  (Package Body) 
--
--  Dependencies: 
--   OC_DIRECCION_REGIONAL_USR (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_DIRECCION_REGIONAL_USR IS
...
--
-- OC_DIRECCION_REGIONAL_USR  (Synonym) 
--
--  Dependencies: 
--   OC_DIRECCION_REGIONAL_USR (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_DIRECCION_REGIONAL_USR FOR SICAS_OC.OC_DIRECCION_REGIONAL_USR
/


GRANT EXECUTE ON SICAS_OC.OC_DIRECCION_REGIONAL_USR TO PUBLIC
/
