CREATE OR REPLACE PACKAGE SICAS_OC.OC_DIAS_ATENCION_SINI AS
...
/
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_DIAS_ATENCION_SINI AS
...
END OC_DIAS_ATENCION_SINI;
/
GRANT EXECUTE, DEBUG ON SICAS_OC.OC_DIAS_ATENCION_SINI TO "PUBLIC";
/
CREATE OR REPLACE PUBLIC SYNONYM OC_DIAS_ATENCION_SINI FOR SICAS_OC.OC_DIAS_ATENCION_SINI;
/
