--
-- GT_FAI_CONFIG_APORTE_FONDO  (Package) 
--
--  Dependencies: 
--   STANDARD (Package)
--   STANDARD (Package)
...
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_FAI_CONFIG_APORTE_FONDO AS
...
--
-- GT_FAI_CONFIG_APORTE_FONDO  (Package Body) 
--
--  Dependencies: 
--   GT_FAI_CONFIG_APORTE_FONDO (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_FAI_CONFIG_APORTE_FONDO AS
...
--
-- GT_FAI_CONFIG_APORTE_FONDO  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_CONFIG_APORTE_FONDO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_CONFIG_APORTE_FONDO FOR SICAS_OC.GT_FAI_CONFIG_APORTE_FONDO
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_CONFIG_APORTE_FONDO TO PUBLIC
/
