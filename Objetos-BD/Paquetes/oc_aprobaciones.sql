...
--   TRANSACCION (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_APROBACIONES IS
  --
...
--
-- OC_APROBACIONES  (Package Body) 
--
--  Dependencies: 
--   OC_APROBACIONES (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_APROBACIONES IS
--
...
--
-- OC_APROBACIONES  (Synonym) 
--
--  Dependencies: 
--   OC_APROBACIONES (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_APROBACIONES FOR SICAS_OC.OC_APROBACIONES
/


GRANT EXECUTE ON SICAS_OC.OC_APROBACIONES TO PUBLIC
/
