...
--
-- GT_DIAS_FESTIVOS  (Synonym) 
--
--  Dependencies: 
--   GT_DIAS_FESTIVOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_DIAS_FESTIVOS FOR SICAS_OC.GT_DIAS_FESTIVOS
/


GRANT EXECUTE ON SICAS_OC.GT_DIAS_FESTIVOS TO PUBLIC
/
