...
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_TRIANGULOS_DATOS IS
...
--
-- OC_TRIANGULOS_DATOS  (Package Body) 
--
--  Dependencies: 
--   OC_TRIANGULOS_DATOS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_TRIANGULOS_DATOS IS
...
--
-- OC_TRIANGULOS_DATOS  (Synonym) 
--
--  Dependencies: 
--   OC_TRIANGULOS_DATOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_TRIANGULOS_DATOS FOR SICAS_OC.OC_TRIANGULOS_DATOS
/


GRANT EXECUTE ON SICAS_OC.OC_TRIANGULOS_DATOS TO PUBLIC
/
