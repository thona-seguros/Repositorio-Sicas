--
-- GT_FACT_ELECT_FACTURA_EXT  (Package) 
--
--  Dependencies: 
--   STANDARD (Package)
--   STANDARD (Package)
--   FACT_ELECT_FACTURA_EXT (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_FACT_ELECT_FACTURA_EXT AS
...
--
-- GT_FACT_ELECT_FACTURA_EXT  (Package Body) 
--
--  Dependencies: 
--   GT_FACT_ELECT_FACTURA_EXT (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_FACT_ELECT_FACTURA_EXT AS
...
--
-- GT_FACT_ELECT_FACTURA_EXT  (Synonym) 
--
--  Dependencies: 
--   GT_FACT_ELECT_FACTURA_EXT (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FACT_ELECT_FACTURA_EXT FOR SICAS_OC.GT_FACT_ELECT_FACTURA_EXT
/


GRANT EXECUTE ON SICAS_OC.GT_FACT_ELECT_FACTURA_EXT TO PUBLIC
/
