...
--
CREATE OR REPLACE PACKAGE SICAS_OC.GT_AUTORIZA_PROCESOS_LOG AS
...
--
-- GT_AUTORIZA_PROCESOS_LOG  (Package Body) 
--
--  Dependencies: 
--   GT_AUTORIZA_PROCESOS_LOG (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.GT_AUTORIZA_PROCESOS_LOG AS
...
--
-- GT_AUTORIZA_PROCESOS_LOG  (Synonym) 
--
--  Dependencies: 
--   GT_AUTORIZA_PROCESOS_LOG (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_AUTORIZA_PROCESOS_LOG FOR SICAS_OC.GT_AUTORIZA_PROCESOS_LOG
/


GRANT EXECUTE ON SICAS_OC.GT_AUTORIZA_PROCESOS_LOG TO PUBLIC
/
