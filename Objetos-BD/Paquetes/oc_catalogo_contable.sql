...
--
CREATE OR REPLACE PACKAGE SICAS_OC.oc_catalogo_contable IS
...
--
-- OC_CATALOGO_CONTABLE  (Package Body) 
--
--  Dependencies: 
--   OC_CATALOGO_CONTABLE (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.oc_catalogo_contable IS
...
--
-- OC_CATALOGO_CONTABLE  (Synonym) 
--
--  Dependencies: 
--   OC_CATALOGO_CONTABLE (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CATALOGO_CONTABLE FOR SICAS_OC.OC_CATALOGO_CONTABLE
/


GRANT EXECUTE ON SICAS_OC.OC_CATALOGO_CONTABLE TO PUBLIC
/
