                    ...
                    --JJG Reporte de Clausulas Asistencias
                         FOR paquete IN (
                            SELECT DISTINCT
                                   ...
                                   X.Titulo_Reporte
                              FROM (
                                    -- Paquetes actuales obtenidos por cláusula 
                                    SELECT DISTINCT
                                    ...
                                    -- Paquetes históricos asignados al asegurado 
                                    SELECT DISTINCT
                                    ...
                                    -- Paquetes históricos asignados al detalle de póliza 
                                    SELECT DISTINCT
                                           A.Id_Paquete             AS Id_Paquete,
                                           TRIM(VL.DescValLst)      AS Titulo_Reporte
...
*/
    ...
    BEGIN
        ...
        END;
                CASE cNombRepor
                    WHEN 'POLIZAVG.rep' THEN cDescReporte := 'P�LIZA VIDA GRUPO';
                    WHEN 'POLIZACA.rep' THEN cDescReporte := 'P�LIZA ACCIDENTES COLECTIVOS';
                    WHEN 'POLCASUB.rep' THEN cDescReporte := 'ACCIDENTES COLECTIVOS SUBGRUPO';
                    WHEN 'POLIZAVI.rep' THEN cDescReporte := 'P�LIZA INDIVIDUAL';
                    WHEN 'POLIZAVF.rep' THEN cDescReporte := 'P�LIZA VIDA FLEX';
                    ...
                    WHEN 'AUTOADMI.rep' THEN cDescReporte := 'P�LIZAS AUTOADMINISTRADAS';
                    ...
                    WHEN 'AVIDEVOL.rep' THEN cDescReporte := 'AVISO DE DEVOLUCI�N';
