...
--
-- OC_DETALLE_FACTURAS  (Synonym) 
--
--  Dependencies: 
--   OC_DETALLE_FACTURAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_DETALLE_FACTURAS FOR SICAS_OC.OC_DETALLE_FACTURAS
/


GRANT EXECUTE, DEBUG ON SICAS_OC.OC_DETALLE_FACTURAS TO PUBLIC
/
