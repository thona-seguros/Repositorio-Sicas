...
--   TICKET_POLIZA (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_TICKET_POLIZA AS
...
--
-- OC_TICKET_POLIZA  (Package Body) 
--
--  Dependencies: 
--   OC_TICKET_POLIZA (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_TICKET_POLIZA AS
...
--
-- OC_TICKET_POLIZA  (Synonym) 
--
--  Dependencies: 
--   OC_TICKET_POLIZA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_TICKET_POLIZA FOR SICAS_OC.OC_TICKET_POLIZA
/


GRANT EXECUTE ON SICAS_OC.OC_TICKET_POLIZA TO PUBLIC
/
