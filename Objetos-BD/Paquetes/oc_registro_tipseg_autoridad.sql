...
--
-- OC_REGISTRO_TIPSEG_AUTORIDAD  (Synonym) 
--
--  Dependencies: 
--   OC_REGISTRO_TIPSEG_AUTORIDAD (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_REGISTRO_TIPSEG_AUTORIDAD FOR SICAS_OC.OC_REGISTRO_TIPSEG_AUTORIDAD
/


GRANT EXECUTE ON SICAS_OC.OC_REGISTRO_TIPSEG_AUTORIDAD TO PUBLIC
/
