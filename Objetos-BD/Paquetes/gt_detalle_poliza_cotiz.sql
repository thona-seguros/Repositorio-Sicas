...
--
-- GT_DETALLE_POLIZA_COTIZ  (Synonym) 
--
--  Dependencies: 
--   GT_DETALLE_POLIZA_COTIZ (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_DETALLE_POLIZA_COTIZ FOR SICAS_OC.GT_DETALLE_POLIZA_COTIZ
/


GRANT EXECUTE ON SICAS_OC.GT_DETALLE_POLIZA_COTIZ TO PUBLIC
/
