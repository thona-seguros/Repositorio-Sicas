...
--
-- OC_CONFIG_RESERVAS_TIPOSEG  (Synonym) 
--
--  Dependencies: 
--   OC_CONFIG_RESERVAS_TIPOSEG (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONFIG_RESERVAS_TIPOSEG FOR SICAS_OC.OC_CONFIG_RESERVAS_TIPOSEG
/


GRANT EXECUTE ON SICAS_OC.OC_CONFIG_RESERVAS_TIPOSEG TO PUBLIC
/
