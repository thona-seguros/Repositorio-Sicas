...
--
-- OC_CENTROS_DE_COSTOS  (Synonym) 
--
--  Dependencies: 
--   OC_CENTROS_DE_COSTOS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CENTROS_DE_COSTOS FOR SICAS_OC.OC_CENTROS_DE_COSTOS
/


GRANT EXECUTE ON SICAS_OC.OC_CENTROS_DE_COSTOS TO PUBLIC
/
