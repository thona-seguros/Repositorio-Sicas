...
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_SOLICITUD_DETALLE IS
...
--
-- OC_SOLICITUD_DETALLE  (Package Body) 
--
--  Dependencies: 
--   OC_SOLICITUD_DETALLE (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_SOLICITUD_DETALLE IS
...
--
-- OC_SOLICITUD_DETALLE  (Synonym) 
--
--  Dependencies: 
--   OC_SOLICITUD_DETALLE (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_SOLICITUD_DETALLE FOR SICAS_OC.OC_SOLICITUD_DETALLE
/


GRANT EXECUTE ON SICAS_OC.OC_SOLICITUD_DETALLE TO PUBLIC
/
