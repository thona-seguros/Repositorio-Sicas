...
--
-- OC_DETALLE_PRIMAS_DEPOSITO  (Synonym) 
--
--  Dependencies: 
--   OC_DETALLE_PRIMAS_DEPOSITO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_DETALLE_PRIMAS_DEPOSITO FOR SICAS_OC.OC_DETALLE_PRIMAS_DEPOSITO
/


GRANT EXECUTE ON SICAS_OC.OC_DETALLE_PRIMAS_DEPOSITO TO PUBLIC
/
