...
--   TICKET_POLIZA_ASEGURADO (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_TICKET_POLIZA_ASEGURADO IS
...
--
-- OC_TICKET_POLIZA_ASEGURADO  (Package Body) 
--
--  Dependencies: 
--   OC_TICKET_POLIZA_ASEGURADO (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_TICKET_POLIZA_ASEGURADO IS
PROCEDURE INSERTAR( nCodCia             IN  TICKET_POLIZA_ASEGURADO.CodCia%TYPE
                  , nCodEmpresa         IN  TICKET_POLIZA_ASEGURADO.CodEmpresa%TYPE
                  , nCodCliente         IN  TICKET_POLIZA_ASEGURADO.CodCliente%TYPE
                  , cCodSucursal        IN  TICKET_POLIZA_ASEGURADO.CodSucursal%TYPE
...
--
-- OC_TICKET_POLIZA_ASEGURADO  (Synonym) 
--
--  Dependencies: 
--   OC_TICKET_POLIZA_ASEGURADO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_TICKET_POLIZA_ASEGURADO FOR SICAS_OC.OC_TICKET_POLIZA_ASEGURADO
/


GRANT EXECUTE ON SICAS_OC.OC_TICKET_POLIZA_ASEGURADO TO PUBLIC
/
