...
--
-- OC_RESERVAS_TECNICAS_REC  (Synonym) 
--
--  Dependencies: 
--   OC_RESERVAS_TECNICAS_REC (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_RESERVAS_TECNICAS_REC FOR SICAS_OC.OC_RESERVAS_TECNICAS_REC
/


GRANT EXECUTE ON SICAS_OC.OC_RESERVAS_TECNICAS_REC TO PUBLIC
/
