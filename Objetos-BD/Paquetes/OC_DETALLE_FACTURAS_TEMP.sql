CREATE OR REPLACE PACKAGE OC_DETALLE_FACTURAS_TEMP IS
--
-- CONTROL DE CAMBIOS
--
...
END OC_DETALLE_FACTURAS_TEMP;
/

CREATE OR REPLACE PACKAGE BODY OC_DETALLE_FACTURAS_TEMP IS
-- 
-- CONTROL DE CAMBIOS
--
-- HOMOLOGACION VIFLEX                                     JMMD     01/03/2022 
...
--
    ...
    BEGIN
DBMS_OUTPUT.PUT_LINE('OC_DETALLE_FACTURAS_TEMP.INSERTAR Monto_Det_Local -> '||nMtoPagoLocal);
DBMS_OUTPUT.PUT_LINE('OC_DETALLE_FACTURAS_TEMP.INSERTAR Monto_Det_Moneda -> '||nMtoPagoMoneda);
       BEGIN
...
DBMS_OUTPUT.PUT_LINE('OC_DETALLE_FACTURAS_TEMP.INSERTAR dupvalindex');
             UPDATE DETALLE_FACTURAS
    ...
    --    
    BEGIN
DBMS_OUTPUT.PUT_LINE('OC_DETALLE_FACTURAS_TEMP.ACTUALIZA_DIFERENCIA nMtoDifLocal ->'||nMtoDifLocal);
DBMS_OUTPUT.PUT_LINE('OC_DETALLE_FACTURAS_TEMP.ACTUALIZA_DIFERENCIA nMtoDifMoneda ->'||nMtoDifMoneda);
       --
       UPDATE DETALLE_FACTURAS
    ...
    BEGIN
DBMS_OUTPUT.PUT_LINE('OC_DETALLE_FACTURAS_TEMP.AJUSTAR');
      FOR X IN CPTO_Q LOOP
          IF X.IndRedondeo = 'S' THEN
             ...
             IF nDifMtoLocal != 0 THEN
                BEGIN
DBMS_OUTPUT.PUT_LINE('OC_DETALLE_FACTURAS_TEMP.AJUSTAR nMtoDetLocal ->'||nMtoDetLocal);
DBMS_OUTPUT.PUT_LINE('OC_DETALLE_FACTURAS_TEMP.AJUSTAR nMtoDetMoneda ->'||nMtoDetMoneda);
                   UPDATE DETALLE_FACTURAS
