...
--
-- GT_POLIZAS_TEXTO_COTIZACION  (Synonym) 
--
--  Dependencies: 
--   GT_POLIZAS_TEXTO_COTIZACION (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_POLIZAS_TEXTO_COTIZACION FOR SICAS_OC.GT_POLIZAS_TEXTO_COTIZACION
/


GRANT EXECUTE ON SICAS_OC.GT_POLIZAS_TEXTO_COTIZACION TO PUBLIC
/
