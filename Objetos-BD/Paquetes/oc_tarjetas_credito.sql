...
--
-- OC_TARJETAS_CREDITO  (Synonym) 
--
--  Dependencies: 
--   OC_TARJETAS_CREDITO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_TARJETAS_CREDITO FOR SICAS_OC.OC_TARJETAS_CREDITO
/


GRANT EXECUTE ON SICAS_OC.OC_TARJETAS_CREDITO TO PUBLIC
/
