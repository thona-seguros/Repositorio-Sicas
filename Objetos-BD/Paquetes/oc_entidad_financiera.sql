...
--
-- OC_ENTIDAD_FINANCIERA  (Synonym) 
--
--  Dependencies: 
--   OC_ENTIDAD_FINANCIERA (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_ENTIDAD_FINANCIERA FOR SICAS_OC.OC_ENTIDAD_FINANCIERA
/


GRANT EXECUTE ON SICAS_OC.OC_ENTIDAD_FINANCIERA TO PUBLIC
/
