...
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_CONFIG_RESERVAS_TARIFAS IS
...
--
-- OC_CONFIG_RESERVAS_TARIFAS  (Package Body) 
--
--  Dependencies: 
--   OC_CONFIG_RESERVAS_TARIFAS (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_CONFIG_RESERVAS_TARIFAS AS
...
--
-- OC_CONFIG_RESERVAS_TARIFAS  (Synonym) 
--
--  Dependencies: 
--   OC_CONFIG_RESERVAS_TARIFAS (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_CONFIG_RESERVAS_TARIFAS FOR SICAS_OC.OC_CONFIG_RESERVAS_TARIFAS
/


GRANT EXECUTE ON SICAS_OC.OC_CONFIG_RESERVAS_TARIFAS TO PUBLIC
/
