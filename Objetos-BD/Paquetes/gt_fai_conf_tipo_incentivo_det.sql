...
--
-- GT_FAI_CONF_TIPO_INCENTIVO_DET  (Synonym) 
--
--  Dependencies: 
--   GT_FAI_CONF_TIPO_INCENTIVO_DET (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM GT_FAI_CONF_TIPO_INCENTIVO_DET FOR SICAS_OC.GT_FAI_CONF_TIPO_INCENTIVO_DET
/


GRANT EXECUTE, DEBUG ON SICAS_OC.GT_FAI_CONF_TIPO_INCENTIVO_DET TO PUBLIC
/
