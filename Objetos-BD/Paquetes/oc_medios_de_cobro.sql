...
--
-- OC_MEDIOS_DE_COBRO  (Synonym) 
--
--  Dependencies: 
--   OC_MEDIOS_DE_COBRO (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_MEDIOS_DE_COBRO FOR SICAS_OC.OC_MEDIOS_DE_COBRO
/


GRANT EXECUTE ON SICAS_OC.OC_MEDIOS_DE_COBRO TO PUBLIC
/
