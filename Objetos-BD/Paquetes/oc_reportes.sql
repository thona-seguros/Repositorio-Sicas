...
--   TRANSACCION (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_REPORTES IS
...
--
-- OC_REPORTES  (Package Body) 
--
--  Dependencies: 
--   OC_REPORTES (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_REPORTES IS
...
--   OC_REPORTES (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_REPORTES FOR SICAS_OC.OC_REPORTES
/


GRANT EXECUTE ON SICAS_OC.OC_REPORTES TO PUBLIC
/
