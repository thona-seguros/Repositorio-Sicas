--
-- OC_SEPARA_NOMBRES  (Package) 
--
--  Dependencies: 
--   STANDARD (Package)
--   DUAL (Synonym)
--   SEPARA_NOMBRES (Table)
--
CREATE OR REPLACE PACKAGE SICAS_OC.OC_SEPARA_NOMBRES IS
...
--
-- OC_SEPARA_NOMBRES  (Package Body) 
--
--  Dependencies: 
--   OC_SEPARA_NOMBRES (Package)
--
CREATE OR REPLACE PACKAGE BODY SICAS_OC.OC_SEPARA_NOMBRES IS
...
--
-- OC_SEPARA_NOMBRES  (Synonym) 
--
--  Dependencies: 
--   OC_SEPARA_NOMBRES (Package)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_SEPARA_NOMBRES FOR SICAS_OC.OC_SEPARA_NOMBRES
/


GRANT EXECUTE ON SICAS_OC.OC_SEPARA_NOMBRES TO PUBLIC
/
