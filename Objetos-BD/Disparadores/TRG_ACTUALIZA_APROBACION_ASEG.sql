  ...
  CREATE OR REPLACE TRIGGER "SICAS_OC"."TRG_ACTUALIZA_APROBACION_ASEG" 
 BEFORE UPDATE ON APROBACION_ASEG
...
-- END IF;
  ...
  VALUES(nMaxtransaccion, 1, 'APROBACION_ASEG ' || :NEW.IdSiniestro, SYSDATE, cIP,
         :NEW.Num_Aprobacion||'-'||:NEW.IdSiniestro||'-'||:NEW.Tipo_Aprobacion, 'MODIFICA APROBACION_ASEG', SUBSTR(cTexto,1,1000), cUsuario);
END;
...
ALTER TRIGGER "SICAS_OC"."TRG_ACTUALIZA_APROBACION_ASEG" ENABLE
