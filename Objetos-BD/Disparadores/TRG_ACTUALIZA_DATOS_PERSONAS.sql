  ...
  CREATE OR REPLACE TRIGGER "SICAS_OC"."TRG_ACTUALIZA_DATOS_PERSONAS" 
 BEFORE
  UPDATE
 ON datos_particulares_personas
   ...
   --           
    ...
    FROM DUAL;
            INSERT INTO LOG_TRANSACCION
              VALUES(nMaxtransaccion,cCodCia,'ACTUALIZO DATOS DE PERSONAS'||' '||TO_CHAR(:NEW.IDPOLIZA),SYSDATE,
              cIP, 'Numero de Persona'||:NEW.IDETPOL, 'ACTUALIZO DATOS DE PERSONAS',
...
ALTER TRIGGER "SICAS_OC"."TRG_ACTUALIZA_DATOS_PERSONAS" ENABLE
