  ...
  CREATE OR REPLACE TRIGGER "SICAS_OC"."TRG_ACTUALIZA_COBERTURA_SINIES" 
 BEFORE UPDATE ON COBERTURA_SINIESTRO
...
BEGIN
  ...
  VALUES(nMaxtransaccion, 1, 'COBERTURA_SINIESTRO ' || :NEW.IdSiniestro, SYSDATE, cIP,
         :NEW.IdSiniestro||'-'||:NEW.CodCobert||'-'||:NEW.NumMod, 'MODIFICA COBERTURA_SINIESTRO', SUBSTR(cTexto,1,1000), cUsuario);
END;
...
ALTER TRIGGER "SICAS_OC"."TRG_ACTUALIZA_COBERTURA_SINIES" ENABLE
