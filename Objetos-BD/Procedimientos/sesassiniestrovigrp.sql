...
--
CREATE OR REPLACE PROCEDURE SICAS_OC.SESASSINIESTROVIGRP (nCodCia NUMBER, nCodEmpresa NUMBER, cCodEntrega VARCHAR2,
...
BEGIN
   ...
   FOR X IN C_ARCHIVO LOOP
      ...
      cCadena := OC_ENTREGAS_CNSF_PLANTILLA.FORMATO_CAMPO(nCodCia, nCodEmpresa, cCodEntrega, cCodPlantilla,
                 ...
                 OC_ENTREGAS_CNSF_PLANTILLA.FORMATO_CAMPO(nCodCia, nCodEmpresa, cCodEntrega, cCodPlantilla,
                                                          OC_CONFIG_PLANTILLAS_CAMPOS.CAMPO(nCodCia, nCodEmpresa, cCodPlantilla, 28), X.PolConcentrada) || cSeparador ||
                 OC_ENTREGAS_CNSF_PLANTILLA.FORMATO_CAMPO(nCodCia, nCodEmpresa, cCodEntrega, cCodPlantilla,
                                                          OC_CONFIG_PLANTILLAS_CAMPOS.CAMPO(nCodCia, nCodEmpresa, cCodPlantilla, 29), cPuntoComa) || CHR(13);
      OC_ARCHIVO.Escribir_Linea(cCadena, cIdUsr, nLinea);
   END LOOP;
   OC_ARCHIVO.Escribir_Linea('EOF', cIdUsr, 0);
END SESASSINIESTROVIGRP;
/

--
-- SESASSINIESTROVIGRP  (Synonym) 
--
--  Dependencies: 
--   SESASSINIESTROVIGRP (Procedure)
--
CREATE OR REPLACE PUBLIC SYNONYM SESASSINIESTROVIGRP FOR SICAS_OC.SESASSINIESTROVIGRP
/


GRANT EXECUTE ON SICAS_OC.SESASSINIESTROVIGRP TO PUBLIC
/
