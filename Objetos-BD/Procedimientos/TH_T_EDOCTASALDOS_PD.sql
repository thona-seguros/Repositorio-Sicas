CREATE OR REPLACE PACKAGE SICAS_OC.TH_T_EDOCTASALDOS_PD IS
...
--               DE MESES Y AÑOS ANTERIORES                                                           JMMD20210720
...
PROCEDURE CARGA_DETALLE_SALDOS(P_IDEJECUCION NUMBER,
                              P_AGENTE       NUMBER,
                              P_CODCIA       NUMBER,
                              P_FECDESDE     DATE,
                              P_FECHASTA     DATE,
...
PROCEDURE GRABA_MOVIMIENTO( P_IDEJECUCION NUMBER,
                            P_COD_AGENTE                      NUMBER,
                            P_FECHA_DESDE                    DATE,
                            P_FECHA_HASTA                    DATE,
                            ...
                            P_FECHA_PAGO                     DATE);
--
PROCEDURE BORRA_MOVIMIENTO(P_IDEJECUCION NUMBER );
--
FUNCTION F_IDEJECUCION RETURN NUMBER;

END TH_T_EDOCTASALDOS_PD;
/
CREATE OR REPLACE PACKAGE BODY SICAS_OC.TH_T_EDOCTASALDOS_PD IS
---
-- CREACION     21/01/2021                                        --                                    JMMDP
-- JMMD 20210628 SE SUSTITUYE EL CURSOR PRINCIPAL POR EL MISMO DEL REPORT CEDOCTA                       JMMD20210628
-- JMMD 20210714 SE AGREGAN UNIONES AL CURSOR PRINCIPAL PARA INCLUIR MOVIMIENTOS
--               DE MESES Y AÑOS ANTERIORES y AGENTES NO ENCONTRADOS EN AGENTES_DISTRIBUCION_COMISION   JMMD20210723
-- JMMD 20210908 SE INCLUYE EN EL CURSOR PRINCIPAL LOS MOVIMIENTOS DE PRY POR CCO                       JMMD20210908
-- JMMD 20211229 SE CAMBIA LA FECHA DE INICIO DE ARRASTRE PARA QUE LA TOME DE UN CATALOGO GENERAL       JMMD20211229
-- JMMD 20220117 SE INCLUYEN VALIDACIONES PARA NUEVOS CONCEPTOS DE COMISION Y HONORARIOS VIFLEX         JMMD20220117
--
...
------------------ jmmd20211229
      DELETE T_EDOSCTA_ARRASTRE_PD;
      COMMIT;
      FOR D IN DETALLES LOOP
          --
          TH_T_EDOCTASALDOS_PD.GRABA_MOVIMIENTO(P_IDEJECUCION,D.COD_AGENTE,P_FECDESDE , P_FECHASTA,
...
BEGIN
  --
  INSERT INTO T_EDOSCTA_ARRASTRE_PD
    (IDEJECUCION,COD_AGENTE,FECHA_DESDE, FECHA_HASTA, NIVEL_AGENTE,DESCRIPCION_RAMO, CODNIVEL,
  ...
  VALUES
    (P_IDEJECUCION,P_COD_AGENTE ,  P_FECHA_DESDE , P_FECHA_HASTA ,
...
--
--
PROCEDURE BORRA_MOVIMIENTO(P_IDEJECUCION NUMBER ) IS
--
BEGIN
  --
  DELETE T_EDOSCTA_ARRASTRE_PD
    WHERE IDEJECUCION = P_IDEJECUCION ;
  --
  COMMIT;
  --
...
--
--
FUNCTION F_IDEJECUCION RETURN NUMBER IS
  NIDEJECUCION NUMBER;
BEGIN
  SELECT SEQ_T_EDOSCTA_ARRASTRE_PD.NEXTVAL
  INTO   NIDEJECUCION
  FROM DUAL;
...
END TH_T_EDOCTASALDOS_PD;
/
GRANT EXECUTE ON SICAS_OC.TH_T_EDOCTASALDOS_PD TO PUBLIC;
/
 
CREATE OR REPLACE PUBLIC SYNONYM TH_T_EDOCTASALDOS_PD FOR SICAS_OC.TH_T_EDOCTASALDOS_PD;
/
