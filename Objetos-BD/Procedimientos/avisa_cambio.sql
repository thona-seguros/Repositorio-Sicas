--
-- AVISA_CAMBIO  (Procedure) 
--
--  Dependencies: 
--   STANDARD (Package)
--   DUAL (Synonym)
--   CAMBIOS_POLIZAS (Table)
--
CREATE OR REPLACE PROCEDURE SICAS_OC.avisa_cambio
...
--
-- AVISA_CAMBIO  (Synonym) 
--
--  Dependencies: 
--   AVISA_CAMBIO (Procedure)
--
CREATE OR REPLACE PUBLIC SYNONYM AVISA_CAMBIO FOR SICAS_OC.AVISA_CAMBIO
/


GRANT EXECUTE ON SICAS_OC.AVISA_CAMBIO TO PUBLIC
/
