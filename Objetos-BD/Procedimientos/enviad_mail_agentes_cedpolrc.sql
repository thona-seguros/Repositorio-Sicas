--
-- ENVIAD_MAIL_AGENTES_CEDPOLRC  (Procedure) 
--
--  Dependencies: 
--   STANDARD (Package)
--   DUAL (Synonym)
...
--   OC_SENDMAIL (Package)
--
CREATE OR REPLACE PROCEDURE SICAS_OC.ENVIAD_MAIL_AGENTES_CEDPOLRC  IS
...
--
-- ENVIAD_MAIL_AGENTES_CEDPOLRC  (Synonym) 
--
--  Dependencies: 
--   ENVIAD_MAIL_AGENTES_CEDPOLRC (Procedure)
--
CREATE OR REPLACE PUBLIC SYNONYM ENVIAD_MAIL_AGENTES_CEDPOLRC FOR SICAS_OC.ENVIAD_MAIL_AGENTES_CEDPOLRC
/


GRANT EXECUTE ON SICAS_OC.ENVIAD_MAIL_AGENTES_CEDPOLRC TO PUBLIC
/
