--
-- NOTIFICACOBRANZADCLSTD  (Procedure) 
--
--  Dependencies: 
--   STANDARD (Package)
--   UTL_TCP (Synonym)
...
--   FACTURAS (Table)
--
CREATE OR REPLACE PROCEDURE SICAS_OC.NOTIFICACOBRANZADCLSTD (nCodCia NUMBER, nCodEmpresa NUMBER, nIdPoliza NUMBER, nIDetPol NUMBER, nIdFactura NUMBER) IS
...
BEGIN
   ...
   cMessage := cHTMLHeader                                                                                                                                                                      ||
               ...
               'Para que usted no quede desprotegido realizaremos un '||cTextoImportanteOpen||'segundo intento'||cTextoImportanteClose||' de cobro a la cuenta bancaria registrada.'            ||
               'O si prefiere puede comunicarse  a nuestro centro de Servicios a Asegurados, el cual estará disponible de lunes a jueves de 9:00 a 18:00 hrs.'                                  ||
               ' y viernes de 9:00 a 15.00 hrs. en los teléfonos (55) 44-33-89-00 opción 2, o bien por Correo electrónico individual@thonaseguros.mx,'                                          ||
               ' donde le proporcionaran un número de referencia bancaria para que pueda pagar en ventanilla.'                                                                                  ||cSaltoLinea||cSaltoLinea||cSaltoLinea||                  
...
END NOTIFICACOBRANZADCLSTD;
/

--
-- NOTIFICACOBRANZADCLSTD  (Synonym) 
--
--  Dependencies: 
--   NOTIFICACOBRANZADCLSTD (Procedure)
--
CREATE OR REPLACE PUBLIC SYNONYM NOTIFICACOBRANZADCLSTD FOR SICAS_OC.NOTIFICACOBRANZADCLSTD
/


GRANT EXECUTE ON SICAS_OC.NOTIFICACOBRANZADCLSTD TO PUBLIC
/
