...
--   TRANSACCION (Table)
--
CREATE OR REPLACE PROCEDURE SICAS_OC.SESASEMISIONVIIND( nCodCia      ENTREGAS_CNSF_CONFIG.CODCIA%TYPE
   ...
   CURSOR C_ARCHIVO IS
      SELECT P.NumPolUnico                                                   Poliza
           ...
           , 0                                                               SldoFondoInv
           , NVL(C.TipoRiesgoAsoc,'1')                                       TipoRiesgoAsoc
           , 1                                                               ExtraPrimaMedBas
           , PC.PlanPoliza
...
--
-- SESASEMISIONVIIND  (Synonym) 
--
--  Dependencies: 
--   SESASEMISIONVIIND (Procedure)
--
CREATE OR REPLACE PUBLIC SYNONYM SESASEMISIONVIIND FOR SICAS_OC.SESASEMISIONVIIND
/


GRANT EXECUTE ON SICAS_OC.SESASEMISIONVIIND TO PUBLIC
/
