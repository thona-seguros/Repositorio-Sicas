...
--
-- ENVIA_MAIL_AGENTES_CEDPOLRC  (Synonym) 
--
--  Dependencies: 
--   ENVIA_MAIL_AGENTES_CEDPOLRC (Procedure)
--
CREATE OR REPLACE PUBLIC SYNONYM ENVIA_MAIL_AGENTES_CEDPOLRC FOR SICAS_OC.ENVIA_MAIL_AGENTES_CEDPOLRC
/


GRANT EXECUTE ON SICAS_OC.ENVIA_MAIL_AGENTES_CEDPOLRC TO PUBLIC
/
