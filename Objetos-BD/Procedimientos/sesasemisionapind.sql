...
--
CREATE OR REPLACE PROCEDURE SICAS_OC.SESASEMISIONAPIND (nCodCia NUMBER, nCodEmpresa NUMBER, cCodEntrega VARCHAR2,
...
CURSOR C_ARCHIVO IS
   SELECT P.NumPolUnico Poliza, 
          ...
          NVL(C.TipoRiesgo,'1') TipoRiesgo, PN.CodPaisRes CodPais, PN.CodProvRes CodEstado,
          P.IdPoliza, P.StsPoliza, P.FecFinVig FecFinVigPol,
          D.IdTipoSeg, D.IDetPol, D.StsDetalle, D.FecFinVig, A.Cod_Asegurado
