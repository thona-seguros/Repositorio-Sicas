--
-- ANUL_FACTURAS_ELECTRONICAS  (Procedure) 
--
--  Dependencies: 
--   STANDARD (Package)
--   UTL_FILE (Synonym)
...
--   FACTURAS (Table)
--
CREATE OR REPLACE PROCEDURE SICAS_OC.ANUL_FACTURAS_ELECTRONICAS IS
...
--
-- ANUL_FACTURAS_ELECTRONICAS  (Synonym) 
--
--  Dependencies: 
--   ANUL_FACTURAS_ELECTRONICAS (Procedure)
--
CREATE OR REPLACE PUBLIC SYNONYM ANUL_FACTURAS_ELECTRONICAS FOR SICAS_OC.ANUL_FACTURAS_ELECTRONICAS
/
