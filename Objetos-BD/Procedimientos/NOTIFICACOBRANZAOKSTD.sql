PROCEDURE          NOTIFICACOBRANZAOKSTD (nCodCia NUMBER, nCodEmpresa NUMBER, nIdPoliza NUMBER, nIDetPol NUMBER, nIdFactura NUMBER) IS
...
BEGIN
   ...
   cMessage := cHTMLHeader                                                                                                                                                                      ||
               ...
               'se realizó el cobro a la cuenta bancaria que nos proporcionó de forma exitosa, correspondiente a la prima de seguro por '                                                       ||
               ...
               ', en horarios de oficina, nuestro teléfono de contacto  (55) 44-33-89-00 opción 2, o bien por Correo electrónico individual@thonaseguros.mx, donde con gusto lo atenderemos.'   ||cSaltoLinea||cSaltoLinea||cSaltoLinea||
