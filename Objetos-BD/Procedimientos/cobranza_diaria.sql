...
--
CREATE OR REPLACE PROCEDURE SICAS_OC.COBRANZA_DIARIA AS
...
--
-- COBRANZA_DIARIA  (Synonym) 
--
--  Dependencies: 
--   COBRANZA_DIARIA (Procedure)
--
CREATE OR REPLACE PUBLIC SYNONYM COBRANZA_DIARIA FOR SICAS_OC.COBRANZA_DIARIA
/


GRANT EXECUTE ON SICAS_OC.COBRANZA_DIARIA TO PUBLIC
/
