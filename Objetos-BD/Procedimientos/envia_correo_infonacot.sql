...
--
-- ENVIA_CORREO_INFONACOT  (Synonym) 
--
--  Dependencies: 
--   ENVIA_CORREO_INFONACOT (Procedure)
--
CREATE OR REPLACE PUBLIC SYNONYM ENVIA_CORREO_INFONACOT FOR SICAS_OC.ENVIA_CORREO_INFONACOT
/


GRANT EXECUTE ON SICAS_OC.ENVIA_CORREO_INFONACOT TO PUBLIC
/
