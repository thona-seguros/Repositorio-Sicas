--
-- OC_PAGOS_SINIESTROS_TEMPORAL  (Procedure) 
--
--  Dependencies: 
--   STANDARD (Package)
--   DBMS_OUTPUT (Synonym)
...
--   TRANSACCION (Table)
--
CREATE OR REPLACE PROCEDURE SICAS_OC.OC_PAGOS_SINIESTROS_TEMPORAL IS
...
--
-- OC_PAGOS_SINIESTROS_TEMPORAL  (Synonym) 
--
--  Dependencies: 
--   OC_PAGOS_SINIESTROS_TEMPORAL (Procedure)
--
CREATE OR REPLACE PUBLIC SYNONYM OC_PAGOS_SINIESTROS_TEMPORAL FOR SICAS_OC.OC_PAGOS_SINIESTROS_TEMPORAL
/
