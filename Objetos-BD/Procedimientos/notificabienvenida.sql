...
--
-- NOTIFICABIENVENIDA  (Synonym) 
--
--  Dependencies: 
--   NOTIFICABIENVENIDA (Procedure)
--
CREATE OR REPLACE PUBLIC SYNONYM NOTIFICABIENVENIDA FOR SICAS_OC.NOTIFICABIENVENIDA
/


GRANT EXECUTE ON SICAS_OC.NOTIFICABIENVENIDA TO PUBLIC
/
