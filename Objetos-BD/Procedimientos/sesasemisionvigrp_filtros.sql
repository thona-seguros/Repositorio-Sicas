CREATE OR REPLACE PROCEDURE SICAS_OC.SESASEMISIONVIGRP_FILTROS( nCodCia      ENTREGAS_CNSF_CONFIG.CODCIA%TYPE
...
CREATE OR REPLACE PUBLIC SYNONYM SESASEMISIONVIGRP_FILTROS FOR SICAS_OC.SESASEMISIONVIGRP_FILTROS
/

GRANT EXECUTE ON SICAS_OC.SESASEMISIONVIGRP_FILTROS TO PUBLIC
/