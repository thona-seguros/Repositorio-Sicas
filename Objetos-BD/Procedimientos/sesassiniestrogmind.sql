...
--
-- SESASSINIESTROGMIND  (Synonym) 
--
--  Dependencies: 
--   SESASSINIESTROGMIND (Procedure)
--
CREATE OR REPLACE PUBLIC SYNONYM SESASSINIESTROGMIND FOR SICAS_OC.SESASSINIESTROGMIND
/


GRANT EXECUTE ON SICAS_OC.SESASSINIESTROGMIND TO PUBLIC
/
