--
-- FACTURAS_ELECTRONICAS  (Procedure) 
--
--  Dependencies: 
--   STANDARD (Package)
--   UTL_FILE (Synonym)
...
--   FACTURAS (Table)
--
CREATE OR REPLACE PROCEDURE SICAS_OC.FACTURAS_ELECTRONICAS IS
...
--
-- FACTURAS_ELECTRONICAS  (Synonym) 
--
--  Dependencies: 
--   FACTURAS_ELECTRONICAS (Procedure)
--
CREATE OR REPLACE PUBLIC SYNONYM FACTURAS_ELECTRONICAS FOR SICAS_OC.FACTURAS_ELECTRONICAS
/
