...
--
CREATE OR REPLACE FUNCTION SICAS_OC.DimeFPagoHoy(vCia      IN saldos_comisiones_pagos.cd_cia%TYPE      ,
...
--
-- DIMEFPAGOHOY  (Synonym) 
--
--  Dependencies: 
--   DIMEFPAGOHOY (Function)
--
CREATE OR REPLACE PUBLIC SYNONYM DIMEFPAGOHOY FOR SICAS_OC.DIMEFPAGOHOY
/


GRANT EXECUTE, DEBUG ON SICAS_OC.DIMEFPAGOHOY TO PUBLIC
/
