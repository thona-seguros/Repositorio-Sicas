--
-- VERIFICA_PASSWORD  (Function) 
--
--  Dependencies: 
--   STANDARD (Package)
--   DBMS_STANDARD (Package)
--
CREATE OR REPLACE FUNCTION SICAS_OC.VERIFICA_PASSWORD(username varchar2, password varchar2, old_password varchar2) RETURN boolean IS
n            BOOLEAN;
m            INTEGER;
differ       INTEGER;
isdigit      BOOLEAN;
...
--
-- VERIFICA_PASSWORD  (Synonym) 
--
--  Dependencies: 
--   VERIFICA_PASSWORD (Function)
--
CREATE OR REPLACE PUBLIC SYNONYM VERIFICA_PASSWORD FOR SICAS_OC.VERIFICA_PASSWORD
/


GRANT EXECUTE ON SICAS_OC.VERIFICA_PASSWORD TO PUBLIC
/
