...
--   CLIENTES (Table)
--   COBRO_REFER_CLI_POL (Table)
--   OC_CLIENTES (Package)
--   DETALLE_POLIZA (Table)
--   DIGITO_VERIFICADOR (Function)
--
CREATE OR REPLACE FUNCTION SICAS_OC.OBTIENE_REFERENCIA
  (P_IDPOLIZA  NUMBER,
...
--
-- OBTIENE_REFERENCIA  (Synonym) 
--
--  Dependencies: 
--   OBTIENE_REFERENCIA (Function)
--
CREATE OR REPLACE PUBLIC SYNONYM OBTIENE_REFERENCIA FOR SICAS_OC.OBTIENE_REFERENCIA
/


GRANT EXECUTE, DEBUG ON SICAS_OC.OBTIENE_REFERENCIA TO PUBLIC
/
