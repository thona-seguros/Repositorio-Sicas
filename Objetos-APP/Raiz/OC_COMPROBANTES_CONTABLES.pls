...
BEGIN
  --
   ...
   IF cCanalComis = 'N' THEN
      ...
      EXCEPTION
         ...
         WHEN TOO_MANY_ROWS THEN
            cCanalComis := 'S';
      END;
      dbms_output.put_line(' 2       cCanalComis   '||cCanalComis); 
   END IF;
   IF cCanalComis = 'N' THEN
      BEGIN
         SELECT 'S'
      ...
      EXCEPTION
         ...
         WHEN TOO_MANY_ROWS THEN
            cCanalComis := 'S';
      END;
      dbms_output.put_line(' 3       cCanalComis   '||cCanalComis); 
   END IF;
   IF cCanalComis = 'N' THEN
      BEGIN
         SELECT 'S'
      ...
      EXCEPTION
         ...
         WHEN TOO_MANY_ROWS THEN
            cCanalComis := 'S';
      END;
      dbms_output.put_line(' 4       cCanalComis   '||cCanalComis); 
   END IF;
   IF cCanalComis = 'N' THEN
      BEGIN
         SELECT 'S'
      ...
      EXCEPTION
         ...
         WHEN TOO_MANY_ROWS THEN
            cCanalComis := 'S';
      END;
      dbms_output.put_line(' 5       cCanalComis   '||cCanalComis); 
   END IF;
   IF cCanalComis = 'N' THEN
      BEGIN
         SELECT 'S'
      ...
      EXCEPTION
         ...
         WHEN TOO_MANY_ROWS THEN
            cCanalComis := 'S';
      END;
      dbms_output.put_line(' 6       cCanalComis   '||cCanalComis); 
   END IF;
   IF cCanalComis = 'N' THEN
      BEGIN
         SELECT 'S'
      ...
      EXCEPTION
         ...
         WHEN TOO_MANY_ROWS THEN
            cCanalComis := 'S';
      END;
      dbms_output.put_line(' 7       cCanalComis   '||cCanalComis); 
   END IF;
   
   
   
   ------  NUEVA VALIDACION   AEVS 20151125   ---------
   ...
   /*IF cCanalComis = 'N' THEN
            ...
            INTO cCanalComis
            FROM TRANSACCION          A,
                 DETALLE_TRANSACCION  B
            WHERE A.IDTRANSACCION = nIdTransaccion---475505 
            AND   A.IDPROCESO = 6
            --
            AND   B.IDTRANSACCION = A.IDTRANSACCION
             AND ( EXISTS ( SELECT C.IDTRANSACCION
                         FROM COBERTURA_SINIESTRO_ASEG C
                         WHERE C.IDTRANSACCION = B.IDTRANSACCION                         
                        )
                 OR    EXISTS ( SELECT D.IDTRANSACCION
                         FROM APROBACION_ASEG D
                         WHERE (  (D.IDTRANSACCION = B.IDTRANSACCION) OR (D.IDTRANSACCIONANUL = B.IDTRANSACCION) )
                        )
                 OR    EXISTS ( SELECT E.IDTRANSACCION
                         FROM APROBACIONES E
                         WHERE ( (E.IDTRANSACCION = B.IDTRANSACCION) OR  (E.IDTRANSACCIONANUL = B.IDTRANSACCION) )
                        )     
                 OR    EXISTS ( SELECT F.IDTRANSACCION
                         FROM COBERTURA_SINIESTRO_ASEG F
                         WHERE F.IDTRANSACCION = B.IDTRANSACCION
                        )          
                      )       
            ;
   END IF;*/
